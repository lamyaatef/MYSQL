  ...
  <body>
    <center>
      <%   
        ...
        //gen.exportChannelPaymentStatusTemplate(templatePath+"/PaymentStatusTemplate.xls",templatePath+"/generated.xls") ;
        ////java.io.File f = new java.io.File("def.xls");
        // out.println(f.exists());
        out.println("<form action=\""+appName+"/cam/template/search list dcm details.xls\" name=\"GenerateSheet\" method=\"post\">");
