        ...
        <form action="<%=appName%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="<%=formName%>" method="post">
            ...
            <input type="hidden" name="<%=MemoInterfaceKey.HIDDEN_SQL_TEMPLATE_ID %>" value="-1">
             ...
             <%if(action.equals(PaymentInterfaceKey.ACTION_VIEW_UPDATE_PAYMENT_EXCEL_ATTRIBUTES )){
            	 ...
            	 String read="";
            	 System.out.println("readdddddddd : " + model.getTempId());
            ...
            <td colspan="2" align="center"> New</td>
             ...
             {
                SqlTemplateModel model=(SqlTemplateModel)PaymentTypeExcelModels.get(i);
                %>
                <option value="<%= model.getTemplateName() %>"><%= model.getTemplateName() %></option>
                <% 
             }
             %>
             </select>
