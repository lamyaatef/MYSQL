...
FROM        
        ...
        WHERE  tt9.COMMISSION_TYPE_CATEGORY_NAME= 'DIST_Line_Unreal_Deduction' AND tt1.MEMO_ID = 110 AND lower(tt2.FLAG) = 'included'  and tt7.COMMISSION_FACTOR_VALUE != 0          
         
         ) xt1 
   
    WHERE xt1.DCM_ID in 
(SELECT tt1.SCM_ID FROM CAM_PAYMENT tt1 JOIN CAM_PAYMENT_SCM_STATUS tt2 ON (tt1.SCM_ID = tt2.SCM_ID ) WHERE tt2.PAYMENT_CAM_STATE_ID=1 AND tt1.MEMO_ID=110)
