...
sum(decode(substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Cash',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as Cash_amount,
sum(decode( substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Magic',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as Magic_amount,
sum(decode( substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Mini Primo',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as Mini_Primo_amount,
sum(decode( substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Primo',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as Primo_amount,
sum(decode( substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Primo Monthly',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as primo_monthly_amount,
sum(decode( substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Primo24',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as Primo24_amount,
sum(decode( substr (commission_item_name, 0, instr(commission_item_name,'_')-1) ,'Sim Swap',commission_item_amount*tt7.COMMISSION_FACTOR_VALUE,0)) as Sim_Swap_amount,
sum(commission_item_amount * tt7.COMMISSION_FACTOR_VALUE) as total_amount
        ...
        and tt7.COMMISSION_FACTOR_VALUE !=0
        GROUP BY 
            tt8.DCM_ID, 
            tt8.DCM_CODE
            , tt8.DCM_NAME 
