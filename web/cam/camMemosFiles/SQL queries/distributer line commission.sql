SELECT 
    ...
    (xt1.xCommission_Total - abs(nvl(xt4.unreal_deduction, 0)) - abs(nvl(xt3.sd_deduction,0))- nvl(xt2.xCommission_Deduction,0)) as  "Net Amount"
FROM        
    ...
    (SELECT tt6.DCM_ID, SUM(tt6.COMMISSION_ITEM_AMOUNT * tt7.COMMISSION_FACTOR_VALUE) AS sd_deduction
        ...
        WHERE tt9.COMMISSION_TYPE_CATEGORY_NAME='DIST_Line_SD Deduction' AND tt1.MEMO_ID = ?            
        GROUP BY 
            tt6.DCM_ID
         ) xt3 on xt1.DCM_ID = xt3.DCM_ID 
    LEFT JOIN
    (SELECT  tt6.DCM_ID, SUM(tt6.COMMISSION_ITEM_AMOUNT * tt7.COMMISSION_FACTOR_VALUE) AS unreal_deduction
        ...
        WHERE tt9.COMMISSION_TYPE_CATEGORY_NAME='DIST_Line_Unreal_Deduction' AND tt1.MEMO_ID = ?           
        GROUP BY
