...
FROM        
    ...
    (SELECT tt6.DCM_ID, SUM(tt6.COMMISSION_ITEM_AMOUNT * tt7.COMMISSION_FACTOR_VALUE) AS sd_deduction
        ...
        WHERE tt10.COMMISSION_TYPE_ID=2 AND tt1.MEMO_ID = 151          
        GROUP BY 
            tt6.DCM_ID
    ...
    (SELECT  tt6.DCM_ID, SUM(tt6.COMMISSION_ITEM_AMOUNT * tt7.COMMISSION_FACTOR_VALUE) AS unreal_deduction
        ...
        WHERE tt9.COMMISSION_TYPE_CATEGORY_NAME='DIST_Line_Unreal_Deduction' AND tt1.MEMO_ID = 151           
        GROUP BY
    ...
    WHERE xt1.DCM_ID in 
(SELECT tt1.SCM_ID FROM CAM_PAYMENT tt1 JOIN CAM_PAYMENT_SCM_STATUS tt2 ON (tt1.SCM_ID = tt2.SCM_ID ) WHERE tt2.PAYMENT_CAM_STATE_ID=1 AND tt1.MEMO_ID=151)
