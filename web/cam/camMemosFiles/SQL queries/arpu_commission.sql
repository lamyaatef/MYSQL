...
SELECT 
    ...
    xt3.negative_amount as "Total Negative Amount",
    xt2.xCommission_Deduction  as "SD Deduction", 
    (xt1.xCommission_Total - xt2.xCommission_Deduction) as  "Net Amount"
...
FROM
    ...
    LEFT JOIN
    (SELECT tt6.DCM_ID, SUM(tt6.COMMISSION_ITEM_AMOUNT * tt7.COMMISSION_FACTOR_VALUE) AS negative_amount
        FROM 
        ...
        WHERE tt10.COMMISSION_TYPE_ID = 2 AND tt1.MEMO_ID = ?           
        GROUP BY 
            tt6.DCM_ID
