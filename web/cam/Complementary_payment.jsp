...
<%
        ...
        String page_header="DCM Payment Status For Complementary Channel "; 
...
document.<%=form_name%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=PaymentInterfaceKey.ACTION_SEARCH_COMPLEMENTARY_CHANNEL%>";
document.<%=form_name%>.submit();
}
