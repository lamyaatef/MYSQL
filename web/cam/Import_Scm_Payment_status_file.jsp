...
<%
        ...
        String page_header="Import DCM Status File";
...
//        String attach_seq = request.getParameter("attach_id");
        ...
        <script language="JavaScript">
            ...
            function checkBefore()
            {
                ...
                if(file_path=="")
                    ...
                    //alert("document.UploadPayment.attach_id.value='"+<%=attach_seq%>+"'");
                    document.UploadPayment.attach_id.value='<%=attach_seq%>';
                    document.UploadPayment.submit();
                }
            ...
            function CreateNewFileInput(inputFile)
            {
                ...
                eval("document.UploadPayment."+nameID+".name='"+file_name+"';");
                eval("document.UploadPayment."+nameID+".id='"+file_name+"';");             
            }
        </script>
    </head>
    ...
    <center><h2> <%=page_header%></h2></center>
        <form ENCTYPE="multipart/form-data" action="<%=appName%>/cam/UploadPayment.jsp?attach_id=<%=attach_seq%>" name="UploadPayment" id="UploadPayment" method="post">
