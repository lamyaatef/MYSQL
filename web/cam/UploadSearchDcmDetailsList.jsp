 			...
 			//	System.out.println("field name= " + fieldName);
 			  ...
 			  try
 			  {
 			   ...
 			   // System.out.println("fileNameOnClient" + fileNameOnClient ) ;
 			    fileUniqueName = "search dcm details list"+".xls";
...
<form action="<%=appName%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="Import" method="post">
        <input type="hidden" name="<%=InterfaceKey.HASHMAP_KEY_ACTION%>" value="<%=MemoInterfaceKey.ACTION_UPLOAD_SEARCH_DCM_DETAILS_LIST%>">
