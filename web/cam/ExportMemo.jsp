...
import="java.io.FileInputStream"
		...
		<%
		 ...
		 String filePath = (String)dataHashMap.get(InterfaceKey.EXPORT_FILE_PATH);
		 //file_path = appName+request.getRealPath("/cam/camMemosFiles/generated PDF files")+"\\"+file_path;
		 filePath = appName+"/cam/camMemosFiles/generated PDF files/"+filePath;
		%>
<html>
<head>
...
<%
out.println("<form action=\""+filePath+"\" name=\"GenerateSheet\" method=\"post\">");
