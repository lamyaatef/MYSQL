...
function submitInsert(paymentType_id)
{
	...
	document.<%=formName%>.<%=PaymentInterfaceKey.HIDDEN_PAYMENT_TYPE_ID%>.value = paymentType_id;
...
<html>
    ...
    <body>
        ...
        <form action="<%=appName%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="<%=formName%>" method="post">
            ...
            <%if(action.equalsIgnoreCase(PaymentInterfaceKey.ACTION_VIEW_PAYMENT_EXCEL_MANAGEMENT)){ %>
            <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
             ...
             <%if(action.equalsIgnoreCase(PaymentInterfaceKey.ACTION_VIEW_PAYMENT_EXCEL_ATTRIBUTES)){
            	 System.out.println("in view attributes");
            ...
            alertNotUnique();
             ...
             %>
              <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
              <TR class=TableHeader>
                <td colspan="5" align="center" ><%=paymentTypeName %> </td> 
              </TR>
              <tr class=TableHeader>
              <td>Excel Sheet Number</td>
              <td>Excel Sheet Name</td>
              <td>Payment Type</td>
              <td>SQL Statement Or Template Name</td> 
              <td>Edit</td>  
              </tr>
