...
String page_header="Issued Memos";
...
document.<%=form_name%>.<%=MemoInterfaceKey.HIDDEN_MEMO_ID%>.value = memo_id;
document.<%=form_name%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=MemoInterfaceKey.ACTION_EXPORT_MEMO%>";
document.<%=form_name%>.submit();
}
...
document.<%=form_name%>.<%=MemoInterfaceKey.HIDDEN_MEMO_ID%>.value = memo_id;
document.<%=form_name%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=MemoInterfaceKey.ACTION_DELETE_ISSUED_MEMO%>";
document.<%=form_name%>.submit();
}
