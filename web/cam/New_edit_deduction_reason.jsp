...
//get data hashmap specidifed b4 in kpihandler
        ...
        ReasonModel item= (ReasonModel)dataHashMap.get(DeductionInterfaceKey.MODEL_DEDUCTION_REASON);
        Vector all_deduction_reason_status = (Vector) dataHashMap.get(DeductionInterfaceKey.VECTOR_REASON_STATUS);
         ...
         String button_acition=DeductionInterfaceKey.ACTION_ADD_REASON;
        String reason_name="";
        String reason_desc="";
        int reason_id = -1;
        ...
        if(item !=null)
        {
         button_acition=DeductionInterfaceKey.ACTION_UPDATE_REASON;
...
<html>
    ...
    <body>
        ...
        <form action="<%=appName%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="<%=form_name%>" method="post">
            ...
            <input type="hidden" name="<%=DeductionInterfaceKey.CONTROL_HIDDEN_REASON_ID%>" value="<%=reason_id%>">   

              
             <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
              <TR class=TableTextNote>
              <td>Name</td><td><input type="text" name="<%=DeductionInterfaceKey.CONTROL_TEXT_REASON_NAME%>" value="<%=reason_name%>"></td>
              </TR>
              <TR class=TableTextNote>
              <td>Status</td>
              <td>
                   ...
                   {%>
                   <select name="<%=DeductionInterfaceKey.CONTROL_SELECT_REASON_STATUS%>" id="<%=DeductionInterfaceKey.CONTROL_SELECT_REASON_STATUS%>">
                   <option>
                   <%
              ...
              <textarea maxlength="256" rows="3" cols="40" name="<%=DeductionInterfaceKey.CONTROL_TEXT_REASON_DESC%>"><%=reason_desc%></textarea>
              </td></TR>
