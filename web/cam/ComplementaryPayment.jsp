...
<%
        ...
        String pageHeader="DCM Payment Status For Complementary Channel "; 
...
document.<%=formName%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=PaymentInterfaceKey.ACTION_EDIT_SCM_PAYMENT_STATUS_COMPLEMENTARY%>";
...
document.<%=formName%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=PaymentInterfaceKey.ACTION_SEARCH_COMPLEMENTARY_CHANNEL%>";
document.<%=formName%>.submit();
}
...
function nextPage()
{
  ...
  document.getElementById('<%=InterfaceKey.HASHMAP_KEY_ACTION%>').value='<%=PaymentInterfaceKey.ACTION_SEARCH_COMPLEMENTARY_CHANNEL%>';
...
function submitExportAsExcel() {
	...
	document.getElementById('<%=InterfaceKey.HASHMAP_KEY_ACTION%>').value='<%=PaymentInterfaceKey.ACTION_EXPORT_DCM_PAYMENT_COMPLEMENTARY_STATUS_EXCEL%>';
	document.<%=formName%>.submit();
}
...
<html>
    ...
    <body>
      ...
      %>">    
               ...
               <%if(action.equalsIgnoreCase(PaymentInterfaceKey.ACTION_VIEW_COMPLEMENTARY_CHANNEL)){%>
            ...
            <%
              if(action.equalsIgnoreCase(PaymentInterfaceKey.ACTION_SEARCH_COMPLEMENTARY_CHANNEL)||
