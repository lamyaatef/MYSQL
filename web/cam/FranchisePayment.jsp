...
<%
        ...
        String pageHeader="DCM Payment Status For Franchise Channel "; 
...
document.<%=formName%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=PaymentInterfaceKey.ACTION_EDIT_SCM_PAYMENT_STATUS_FRANCHISE%>";
...
document.<%=formName%>.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value="<%=PaymentInterfaceKey.ACTION_SEARCH_FRANCHISE_CHANNEL%>";
document.<%=formName%>.submit();
}
...
function nextPage()
{
  ...
  document.getElementById('<%=InterfaceKey.HASHMAP_KEY_ACTION%>').value='<%=PaymentInterfaceKey.ACTION_SEARCH_FRANCHISE_CHANNEL%>';
...
function submitExportAsExcel() {
	...
	document.getElementById('<%=InterfaceKey.HASHMAP_KEY_ACTION%>').value='<%=PaymentInterfaceKey.ACTION_EXPORT_DCM_PAYMENT_FRANCHISE_STATUS_EXCEL%>';
	document.<%=formName%>.submit();
}
...
<html>
    ...
    <body>
      ...
      %>">    
               ...
               <%if(action.equalsIgnoreCase(PaymentInterfaceKey.ACTION_VIEW_FRANCHISE_CHANNEL)){%>
            ...
            <%
              if(action.equalsIgnoreCase(PaymentInterfaceKey.ACTION_SEARCH_FRANCHISE_CHANNEL)||
