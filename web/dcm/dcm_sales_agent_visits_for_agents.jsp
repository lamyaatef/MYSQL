...
%> 
      ...
      <TR class=TableTextNote>
        ...
        <td align=middle><Script>drawCalender('<%=DCMInterfaceKey.INPUT_SEARCH_TEXT_VISIT_CREATION_DATE_FROM%>',"<%=searchCreationDateFrom%>");</script></td>
        <td align=middle>Visit Date To</td>
        <td align=middle><Script>drawCalender('<%=DCMInterfaceKey.INPUT_SEARCH_TEXT_VISIT_CREATION_DATE_TO%>',"<%=searchCreationDateTo%>");</script></td>
      ...
      <tr>
        ...
        <%
        out.print("<INPUT class=button type=button value=\" Search \" name=\"searchrequest\" id=\"searchrequest\" onclick=\"document.DCMform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+DCMInterfaceKey.ACTION_DCM_SEARCH_SALES_AGENT_VISITS_FOR_AGENT+"';"+
                  "DCMform.submit();\">");
     ...
     <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
        ...
        <TR class=TableTextNote>
         ...
         out.println("<input type=\"hidden\" name=\""+DCMInterfaceKey.INPUT_HIDDEN_VISIT_STATUS_ID+"_"+visitPlanId+"\""+
          ...
          <TD align='center'>
          <%
            out.print("<INPUT class=button type=button value=\" Edit \" name=\"edit\" id=\"edit\" onclick=\"document.DCMform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+DCMInterfaceKey.ACTION_DCM_EDIT_SALES_AGENT_VISIT_FOR_AGENT+"';"+
    ...
    <br><br>
      <center>
      <%
        out.print("<INPUT class=button type=button value=\" Add New Visit \" name=\"addnewvisit\" id=\"addnewvisit\" onclick=\"document.DCMform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+DCMInterfaceKey.ACTION_DCM_CREATE_NEW_SALES_AGENT_VISIT_FOR_AGENT+"';"+
                  "DCMform.submit();\">");
      %>
      </center>
