...
<%!
  ...
  { 
    ...
    out.println("<CENTER>");
    out.println("  <H2>Edit Region</H2>");
    out.println("</CENTER>");
  
    
    HashMap objDataHashMap = new HashMap(100);
    ...
    String strRegion = (String)objDataHashMap.get(DCMInterfaceKey.INPUT_HIDDEN_REGION_NAME);
    ...
    out.println("    </tr>");
    out.println("    <TR>");
    out.println("      <TD align='center'><input type='tect' name='' id='' value='"+strRegion+"'></TD>");
    out.println("    </tr>");
    out.println("  </table>  ");
    out.println("  <br>");
    ...
    out.println("<TR>");
    out.println("  <TD class=TableHeader vAlign=top colSpan=2>Child Regions");
    ...
    out.println("   user_defined_data_view.ColumnHeaders.add(null,null,\"Regions\",null,200,\"center\",DG_TEXT,null,null,null)   ");
