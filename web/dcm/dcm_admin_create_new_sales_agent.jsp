...
<%!
  ...
  { 
    ...
    out.println("<CENTER>");
    out.println("  <H2>Add New Sales Agents</H2>");
    out.println("</CENTER>");
    ...
    out.println("   user_defined_data_view.ColumnHeaders.add(null,null,\"System User\",null,150,\"center\",DG_TEXT,null,null,null)   ");
    out.println("   user_defined_data_view.ColumnHeaders.add(null,null,\"Region\",null,150,\"center\",DG_SELECT,null,null,null)   ");
