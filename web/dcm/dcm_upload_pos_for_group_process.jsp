...
String groupId = (String)request.getParameter(DCMInterfaceKey.INPUT_HIDDEN_GROUP_ID);
//System.out.println("Group ID issssssssssss " + groupId);
...
printToStream("<script type=\"text/javascript\">",out,pw);
  ...
  Vector vecTmpPosGroup = GroupDAO.getTmpPosGroup(con);
  //System.out.println("The Vector Size isssssssssssssssssss "+ vecTmpPosGroup.size() );
  for(int i = 0;i<vecTmpPosGroup.size();i++)
  {
    PosGroupImportModel posGroupImportModel = (PosGroupImportModel)vecTmpPosGroup.get(i);
    String tmRowNum = posGroupImportModel.getRowNum();
    //System.out.println("The Row Num isssssssssssssss " + tmRowNum);
    String posCode = posGroupImportModel.getPosCode();
    //System.out.println("The POS Code issssssssssssssssss " + posCode);
    ...
    if(posExists)
    {
        ...
        String posName = "";
        GroupDAO.saveGroupPOS(con,posName,posCode,groupId);
  ...
  GroupDAO.deleteTmpPosGroup(con);
