...
%> 
      ...
      <tr class=TableTextNote>
        ...
        <td align='right'><input type='checkbox' name='' id=''></td>
      </tr>
      <tr class=TableTextNote>
        <td colspan=3>
      ...
      <center>
        <%
        out.print("<INPUT class=button type=button value=\" Next \" name=\"moveregions\" id=\"moveregions\" onclick=\"document.DCMform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+DCMInterfaceKey.ACTION_DCM_MOVE_REGIONS_SELECT_DESTINATION+"';"+
                  "DCMform.submit();\">");          
        %>
      </center>
</form>
