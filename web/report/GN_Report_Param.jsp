...
{
argOut.println("<form action=\"../servlet/com.mobinil.sds.web.controller.WebControllerServlet\" name=\"ReportParameters\" id=\"ReportParameters\" method=\"post\">");
 
argOut.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+" value=\""+ReportInterfaceKey.ACTION_PREVIEW_REPORT+"\">");
argOut.println("<input type=\"hidden\" name=\""+ReportInterfaceKey.PARAM_PREVIEW_REPORT_PARAMS_NUM+"\""+" value=\""+"\">");
argOut.println("<input type=\"hidden\" name=\""+ReportInterfaceKey.PARAM_PREVIEW_REPORT_ID+"\""+" value=\""+"\">");
argOut.println("<input type=\"hidden\" name=\""+ReportInterfaceKey.PARAM_PREVIEW_REPORT_ROWS_PER_PAGE+"\""+" value=\""+"\">");                    
argOut.println("<input type=\"hidden\" name=\""+ReportInterfaceKey.PARAM_PREVIEW_REPORT_PAGE_NUM+"\""+" value=\""+"\">");                    
    ...
    int rowPerPage = 200;
        if( colParameters.size() == 0)
        {
            ...
            argOut.println("document.ReportParameters."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+ReportInterfaceKey.ACTION_PREVIEW_REPORT+"' ");
            ...
            argOut.println("document.ReportParameters."+ReportInterfaceKey.PARAM_PREVIEW_REPORT_ROWS_PER_PAGE+".value="+rowPerPage+";");  
