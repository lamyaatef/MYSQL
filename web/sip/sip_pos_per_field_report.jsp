...
<input type="hidden" name="<%= SIPInterfaceKey.HIDDEN_PARAM_NAME_SIP_REPORT %>" id="<%= SIPInterfaceKey.HIDDEN_PARAM_NAME_SIP_REPORT%>" value="<%= SIPInterfaceKey.HIDDEN_PARAM_SIP_REPORT_POS%>">
    <center>
