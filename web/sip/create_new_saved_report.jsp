...
<tr>
  <td height="14" colspan="6" class="TableHeader">Report Details</td>
</tr>
  ...
  <tr>
  <td height="27" class="TableTextNote">Report Channel </td>
  ...
  <tr>
    <td height="28" class="TableTextNote">Report Category </td>
    <td class="TableTextNote"><select name="<%=CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_CATEGORY%>" id="<%=CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_CATEGORY%>">
    <option></option>
    <%
  ...
  <tr>
    <td height="26" class="TableTextNote"> Data View</td>
  ...
  <tr>
    <td class="TableTextNote">Report Description </td>
