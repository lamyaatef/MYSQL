...
<center>
      <h2>Upload List Of DCM Per ExPOS and Non ExPOS</h2>
      </center>
<input type="hidden" name="sip_action" id="sip_action" value="<%=SIPInterfaceKey.ACTION_HIDDEN_PARAM_NAME_UPLOAD_DATA %>">
<input type="hidden" name="<%= SIPInterfaceKey.ACTION_HIDDEN_PARAM_NAME_PREVIOUS_ACTION%>" id="<%= SIPInterfaceKey.ACTION_HIDDEN_PARAM_NAME_PREVIOUS_ACTION %>" value="<%=SIPInterfaceKey.ACTION_UPLOAD_DCM_EXPOS %>">
<input type="hidden" name="<%= SIPInterfaceKey.HIDDEN_PARAM_NAME_SIP_REPORT %>" id="<%= SIPInterfaceKey.HIDDEN_PARAM_NAME_SIP_REPORT%>" value="<%= SIPInterfaceKey.HIDDEN_PARAM_SIP_REPORT_EXPOS%>">
    <center>
