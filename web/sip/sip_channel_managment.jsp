...
<html>
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      document.channelManagment.<%out.print(InterfaceKey.HASHMAP_KEY_ACTION);%>.value="<%out.print(SIPInterfaceKey.ACTION_SIP_ASSIGN_CHANNEL_TO_USER);%>";
    ...
    <form action="<%out.print(appName);%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="channelManagment" method="post">
      ...
      value="<%out.print(SIPInterfaceKey.ACTION_SIP_ASSIGN_CHANNEL_TO_USER);%>">

      <input type="hidden" name="<%out.print(SIPInterfaceKey.CONTROL_HIDDEN_CHANNEL_ID);%>" 
      value="">
  ...
  throws ServletException, IOException
  {
    ...
    if(! dataHashMap.isEmpty())
    {
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        Vector vecChannelList = (Vector) dataHashMap.get (SIPInterfaceKey.CHANNEL_VECTOR) ;
        Vector personChannelList = (Vector) dataHashMap.get (SIPInterfaceKey.USER_CHANNEL_VECTOR) ;
        ...
        {
          SIPChannelModel cm =  (SIPChannelModel) vecChannelList.elementAt (j);
        ...
        out.print(channelName);    
         ...
         for (int t=0;t<personChannelList.size();t++)
         {
        	...
        	int userId = ((SIPChannelModel)personChannelList.elementAt(t)).getChannelId().intValue();	
        	String channelValue =((SIPChannelModel)personChannelList.elementAt(t)).getChannelName();
