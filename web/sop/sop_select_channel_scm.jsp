...
Utility.logger.debug(objDataHashMap);
  ...
  Vector channelVec = (Vector)objDataHashMap.get(InterfaceKey.HASHMAP_KEY_COLLECTION);
  Vector scmChannelVec = (Vector)objDataHashMap.get(InterfaceKey.HASHMAP_KEY_ADDITIONAL_COLLECTION);
...
%>
        ...
        <tr>
          ...
          <script>
            function changeSCMSelect(superTypeValue)
            {
                ...
                <%
                for(int l=0;l<scmChannelVec.size();l++)
                {
                  ChannelDCMModel channelDCMModel = (ChannelDCMModel)scmChannelVec.get(l);
        ...
        <TR >
          ...
          <TD >
            ...
            <option value=""></option>
              <%
              for(int k=0;k<scmChannelVec.size();k++)
              {
                ChannelDCMModel channelDcmModel = (ChannelDCMModel)scmChannelVec.get(k);
