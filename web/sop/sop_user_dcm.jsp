 ...
 */ 
  ...
  */
  ...
  // complemantry added
   ...
   else if (strChannelId.equals("2"))
    statement = "Franchise";
  
   else if (strChannelId.equals("3"))
...
<html>
  ...
  <body>
      ...
      <left>
       <h3>User <%=statement%> Managment </h3>
    ...
    <form action="<%out.print(appName);%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="UserManagment" method="post">
      ...
      <input type="hidden" name="<%out.print(SOPInterfaceKey.INPUT_HIDDEN_CHANNEL_ID);%>" value="<%out.print(strChannelId);%>">
...
<%!
  ...
  throws ServletException, IOException
  {
    ...
    {
      String userID = (String)dataHashMap.get(InterfaceKey.HASHMAP_KEY_USER_ID);
      String channelId = (String)dataHashMap.get(SOPInterfaceKey.INPUT_HIDDEN_CHANNEL_ID);
      String statement1 = "";
      String statement2 = "";
      ...
      */
      ...
      {
    	  statement1="Complemantries";
    	  statement2="Complemantry";
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        out.print(" value=\""+SOPInterfaceKey.ACTION_SOP_UPDATE_USER_DCM+"\">");
        out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_USER_ID+"\" value=\""+userID+"\">");
        out.println("<input type=\"hidden\" name=\""+SOPInterfaceKey.INPUT_HIDDEN_CHANNEL_ID+"\" value=\""+channelId+"\">");
        ...
        out.println("<TR class=TableHeader><td colspan=3 nowrap align=middle>"+personName+" "+statement1+"</td></tr>");
        out.println("<TR class=TableHeader>");
        out.println("<td width=\"40%\" nowrap align=middle>"+statement2+" Name</td>");
        out.println("<td width=\"40%\" nowrap align=middle>"+statement2+" Code</td>");
