...
<script>
 ...
 function setSearchValues(creationDateFrom,creationDateTo,paymentDateFrom,paymentDateTo,warehouseId)
  ...
  HashMap scratchReport = (HashMap)objDataHashMap.get(InterfaceKey.HASHMAP_KEY_ADDITIONAL_COLLECTION);
...
<TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
      ...
      <tr class=TableTextNote>  
        ...
        <td align=middle><Script>drawCalender('<%=SOPInterfaceKey.INPUT_SEARCH_TEXT_CREATION_DATE_TO%>','<%=searchCreationDateTo%>',"*");</script></td>
      </tr>
...
<%--      <tr class=TableTextNote>
      ...
      <tr>
        ...
        <%
        out.print("<INPUT class=button type=button value=\" Search \" name=\"searchScratch\" id=\"searchScratch\" onclick=\"document.SOPform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SOPInterfaceKey.ACTION_SEARCH_SCRATCH_REPORT+"';"+
                  "SOPform.submit();\">");
...
<%
 Set set = scratchReport.entrySet();
...
%>
  ...
  <%
  Map mapdcms = Collections.synchronizedMap(new TreeMap(scratchReport));
...
if(objDataHashMap.containsKey(InterfaceKey.HASHMAP_KEY_ACTION))
  {
    ...
    if(strAction.compareTo(SOPInterfaceKey.ACTION_SEARCH_SCRATCH_REPORT)==0)
    {
