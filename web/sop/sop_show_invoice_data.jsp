...
%>
 ...
 <br><br>
    <center>
<%
      out.print("<INPUT class=button type='button' value=\" Add New Invoice \" name=\"new\" id=\"new\" onclick=\"document.SOPform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SOPInterfaceKey.ACTION_CREATE_NEW_INVOICE+"';"+
                  "SOPform.submit();\">");
%>
</center>
 </form>
