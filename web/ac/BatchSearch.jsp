...
<%
/**
 * Authentication_CAll_Batch_Search.jsp:
...
throws java.io.IOException
{
  ...
  */
  ...
  throws ServletException, IOException
  {
    ...
    DCMDto dcmDto= (DCMDto) additionalCollection.get(ContractRegistrationInterfaceKey.OBJ_DCM_DTO);
    BatchTypeDto batchTypeDto= (BatchTypeDto)additionalCollection.get(ContractRegistrationInterfaceKey.OBJ_BATCH_TYPE_DTO);
    BatchStatusTypeDto batchStatusTypeDto= (BatchStatusTypeDto) additionalCollection.get(ContractRegistrationInterfaceKey.OBJ_BATCH_STATUS_TYPE_DTO);   
    ...
    out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\" value=\""+AuthCallInterfaceKey.ACTION_SEARCH_BATCH_AUTHENTICATION_CALL_BY_SHEET+"\">");
    ...
    String searchDcmID = (String)additionalCollection.get(ContractRegistrationInterfaceKey.CONTROL_SELECT_DCM_ID);
    String searchbatchDate = (String)additionalCollection.get(ContractRegistrationInterfaceKey.CONTROL_BATCH_DATE);
    String searchbatchType = (String)additionalCollection.get(ContractRegistrationInterfaceKey.CONTROL_SELECT_BATCH_TYPE);
    String searchbatchStatusType = (String)additionalCollection.get(ContractRegistrationInterfaceKey.CONTROL_SELECT_BATCH_STATUS_TYPE);
...
//      out.println("<td nowrap align=middle>Open for Commissioning</td></tr>");
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        "document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+AuthCallInterfaceKey.ACTION_SHOW_CHOOSE_CONTRACTS_FOR_AUTHENTICATION_CALL_SCREEN_BY_SHEET+"';"+
...
/*
        if(batchStatus.compareTo(BatchModel.STATUS_OPEN_COMMISSION)==0)
        {
          ...
          " onclick=\"document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+AuthCallInterfaceKey.ACTION_UPDATE_BATCH_TO_COMMISSION+"';"+
          " document.BatchPrint."+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID+".value="+batchID+";"+
    ...
    else 
    {
      ...
      {
        if(((String)request.getAttribute(InterfaceKey.HASHMAP_KEY_ACTION)).compareTo(AuthCallInterfaceKey.ACTION_SEARCH_BATCH_AUTHENTICATION_CALL_BY_SHEET)==0)
        {
