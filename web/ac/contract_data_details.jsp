...
<html>
  ...
  <body onkeypress = "if(event.keyCode==13){checkbeforSubmit();}">
    <Center>
      <H2>Admin Authentication Call</H2>
    </Center>
  ...
  throws ServletException, IOException
  {
    ...
    if(dataHashMap != null)
    {
      if(! dataHashMap.isEmpty())
      {
        ...
        String contractDialNumber = (String)dataHashMap.get(AuthCallInterfaceKey.INPUT_HIDDEN_DIAL_NUMBER);
        System.out.println ("user id in the jsp isssssssss " + userID);
        String batchLastStatus = (String)dataHashMap.get(ContractRegistrationInterfaceKey.CONTROL_TEXT_BATCH_LAST_STATUS_ID);
        System.out.println ("batchLastStatus issssssssssssssssss " + batchLastStatus);
        String contractLastStatus = (String)dataHashMap.get(ContractRegistrationInterfaceKey.CONTROL_TEXT_CONTRACT_LAST_STATUS_ID);
        System.out.println ("contractLastStatus issssssssssssssssss " + contractLastStatus);
        ...
        {dcmID = batchSheetModel.getDcmId();System.out.println("dcmID isssssssssssssssssss " + dcmID);
        }
        ...
        //System.out.println("batchID isssssssssssssssssss " + batchID);
        }
        ...
        //System.out.println("batchDate isssssssssssssssssss " + batchDate);
        }
        ...
        //System.out.println("batchType isssssssssssssssssss " + batchType);
        }
        ...
        //System.out.println("batchStatusType isssssssssssssssssss " + batchStatusType);
        }
        ...
        //System.out.println("sheetID isssssssssssssssssss " + sheetID);
        }
        ...
        {sheetSerialNo = batchSheetModel.getSheetSerialId();
        //System.out.println("sheetSerialNo isssssssssssssssssss " + sheetSerialNo);
        }
       ...
       // String sheetStatus = (String)dataHashMap.get(ContractRegistrationInterfaceKey.CONTROL_HIDDEN_SHEET_STATUS);
        ...
        //System.out.println("contractSimNo isssssssssssssssssss " + contractSimNo);
        ContractModel contractModel = (ContractModel)dataHashMap.get(InterfaceKey.HASHMAP_KEY_COLLECTION);
        //System.out.println("contractModel isssssssssssssssssss ");
        ...
        //System.out.println("contractStatusTypeDto isssssssssssssssssss ");
        ...
        //System.out.println("doesContractHasPreviousWarning isssssssssssssssssss " + doesContractHasPreviousWarning);
        Boolean posQuestionFlag = (Boolean)dataHashMap.get(AuthCallInterfaceKey.OBJ_POS_QUESTION_FLAG);
        //System.out.println("posQuestionFlag isssssssssssssssssss " + posQuestionFlag);
        contractId = contractModel.getId();
        System.out.println ("The contract id in jsp isssssssss " + contractId);
        ...
        String sheetSuperDealerCode = batchSheetModel.getSuperDealerCode();
        String cityArabic = contractModel.getCityArabic();
        if(cityArabic == null) cityArabic = "";
        String cityEnglish = batchSheetModel.getCityName();
        ...
        out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+
                    " value=\""+AuthCallInterfaceKey.ACTION_UPDATE_CONTRACT+"\">");

        out.println("<input type=\"hidden\" name=\""+AuthCallInterfaceKey.INPUT_HIDDEN_DIAL_NUMBER+
                    "\" value="+contractDialNumber+">");
...
//System.out.println("beforeeeeeeeeeeeeeeeeeeeeeeee");
        ...
        //}
        out.println("</select>");
        //System.out.println("afterrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr");
        ...
        out.println("<td nowrap >"+batchSheetModel.getPosName()+"</td>");
        out.println("</tr>");
        out.println("</tr>");
        String posAddress = batchSheetModel.getPosAddress();
        if(posAddress == null)posAddress = "";
        out.println("<td class=TableHeader ><font size=2>POS Address</font></TD>");      
        out.println("<td nowrap >"+posAddress+"</td>");
        out.println("</tr>");
        out.println("<TR>");
        ...
        " onclick=\"xaddToList("+ContractRegistrationInterfaceKey.CONTROL_SELECT_USER_WARNINGS+", "+ContractRegistrationInterfaceKey.CONTROL_SELECT_APPLYED_USER_WARNINGS+");getSuggestedStatus();\"></TD>");
        ...
        " onclick=\"xaddAll("+ContractRegistrationInterfaceKey.CONTROL_SELECT_USER_WARNINGS+", "+ContractRegistrationInterfaceKey.CONTROL_SELECT_APPLYED_USER_WARNINGS+");getSuggestedStatus();\"></TD>");
        out.println("</tr>");
        out.println("<TR >");
        out.println("<td width=\"5%\"><input class=\"button\" type=\"button\" name=\"removeFromList\" value=\"  <   \""+
        " onclick=\"xremoveFromList("+ContractRegistrationInterfaceKey.CONTROL_SELECT_USER_WARNINGS+", "+ContractRegistrationInterfaceKey.CONTROL_SELECT_APPLYED_USER_WARNINGS+");getSuggestedStatus();\"></TD>");
        out.println("</tr>");
        out.println("<TR >");
        out.println("<td width=\"5%\"><input class=\"button\" type=\"button\" name=\"removeAll\" value=\" << \""+
        " onclick=\"xremoveAll("+ContractRegistrationInterfaceKey.CONTROL_SELECT_USER_WARNINGS+", "+ContractRegistrationInterfaceKey.CONTROL_SELECT_APPLYED_USER_WARNINGS+");getSuggestedStatus();\"></TD>");
        out.println("</tr>");
        out.println("<TR >");
        ...
        out.println("<TR >");
        out.println("<td class=TableHeader  width=\"30%\">Contract Status</TD>");      
        out.println("<td>");
        ...
        out.println("<input type=\"hidden\" name=\""+ContractRegistrationInterfaceKey.CONTROL_TEXT_CONTRACT_SIM_NO+"\" value=\""+contractSimNO+"\">");
         ...
         if (batchLastStatus .compareTo("7")==0)
         {
        	 if(contractLastStatus .compareTo("5")==0 ||contractLastStatus .compareTo("7")==0 || contractLastStatus .compareTo("8")==0 || contractLastStatus .compareTo("9")==0)
