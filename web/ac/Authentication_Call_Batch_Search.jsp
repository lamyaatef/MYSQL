...
throws java.io.IOException
{
  ...
  */
  ...
  throws ServletException, IOException
  {
    ...
    out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\" value=\""+AuthCallInterfaceKey.ACTION_SEARCH_BATCH_AUTHENTICATION_CALL+"\">");
...
//      out.println("<td nowrap align=middle>Open for Commissioning</td></tr>");
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        "document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+AuthCallInterfaceKey.ACTION_SHOW_CHOOSE_CONTRACTS_FOR_AUTHENTICATION_CALL_SCREEN+"';"+
...
/*
    ...
    else 
    {
      ...
      {
        if(((String)request.getAttribute(InterfaceKey.HASHMAP_KEY_ACTION)).compareTo(AuthCallInterfaceKey.ACTION_SEARCH_BATCH_AUTHENTICATION_CALL)==0)
        {
