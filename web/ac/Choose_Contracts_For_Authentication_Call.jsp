     ...
     <h3>Choose Contract for Authentication Call</h3>
      ...
      <SCRIPT language=JavaScript>
        function checkbeforSubmit()
        {
          ...
          else if(document.AuthCall.<%out.print(ContractRegistrationInterfaceKey.CONTROL_TEXT_SHEET_SERIAL_NO);%>.disabled==false)
          {
            if(NonBlank(document.AuthCall.<%out.print(ContractRegistrationInterfaceKey.CONTROL_TEXT_SHEET_SERIAL_NO);%>, true, 'Sheet Serial NO'))
            {
              document.AuthCall.submit();          
            }
            return false;
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        if(newBatchDto != null)
        {
          ...
          out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+
                      " value=\""+AuthCallInterfaceKey.ACTION_CHOOSE_CONTRACTS_FOR_AUTHENTICATION_CALL+"\">");
          ...
          out.println("<TR><td colspan=2><input type=\"radio\" name=\""+AuthCallInterfaceKey.CONTROL_RADIO_VIEW_CONTRACTS+
                      ...
                      "AuthCall."+ContractRegistrationInterfaceKey.CONTROL_TEXT_SHEET_SERIAL_NO+".disabled=true;\">View All Authinticated</TD></TR>");

          out.println("<TR><td colspan=2><input type=\"radio\" name=\""+AuthCallInterfaceKey.CONTROL_RADIO_VIEW_CONTRACTS+
                      "\" value=\""+AuthCallInterfaceKey.VIEW_ALL+"\" onclick=\"AuthCall.view.disabled=false;"+
                      "AuthCall."+ContractRegistrationInterfaceKey.CONTROL_TEXT_CONTRACT_SIM_NO+".disabled=true;"+
                      "AuthCall."+ContractRegistrationInterfaceKey.CONTROL_TEXT_SHEET_SERIAL_NO+".disabled=true;\">View All Contracts</TD></TR>");      

          out.println("<TR><td colspan=2><input type=\"radio\" name=\""+AuthCallInterfaceKey.CONTROL_RADIO_VIEW_CONTRACTS+
                      "\" value=\""+AuthCallInterfaceKey.ADD_RANDOM_CONTRACTS+"\" onclick=\"AuthCall.view.disabled=false;"+
                      "AuthCall."+ContractRegistrationInterfaceKey.CONTROL_TEXT_CONTRACT_SIM_NO+".disabled=true;"+
                      "AuthCall."+ContractRegistrationInterfaceKey.CONTROL_TEXT_SHEET_SERIAL_NO+".disabled=true;\">Add Random Contracts</TD></TR>");
          ...
          out.println("<TR><td width=\"35%\"><input type=\"radio\" name=\""+AuthCallInterfaceKey.CONTROL_RADIO_VIEW_CONTRACTS+
                      ...
                      "AuthCall."+ContractRegistrationInterfaceKey.CONTROL_TEXT_SHEET_SERIAL_NO+".disabled=true;\">Add Contract with this Main Sim NO</TD>");
          ...
          if(contractDtos != null)
          {
            ...
            for(int j=0; j<contractDtos.size(); j++)
            {
              ...
              boolean isSheetReImported = sheetsReimportedTable.containsKey(sheetStatistic.getSheetId());
              ...
              {                                          
                ...
                else
                {
                  ...
                  "document.AuthCall."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+AuthCallInterfaceKey.ACTION_SHOW_CONTRACT_DETAILS_FOR_AUTHENTICATION_CALL+"'; "+
          ...
          out.println("onclick=\"document.AuthCall."+
                      ...
                      AuthCallInterfaceKey.ACTION_SEARCH_BATCH_AUTHENTICATION_CALL+"';AuthCall.submit();\">");
          out.print("</td>");
          out.print("</tr>");
