...
<%    
    ...
    String warehouse = (String) request.getParameter(LevelRelationManagementInterfaceKey.CONTROL_SELECT_WAREHOUSE);
    ...
    if (true) {
        ...
        // delete temp data
        LevelRelationManagementDAO.truncateTableWarehouseToLevelZeroTemp();
        ...
        out.println("Operation Was Completed");
        {
            ...
            // {
            List<String> tempList = LevelRelationManagementDAO.getTmpWarehouseToLevelZeroData();
            ...
            for (int i = 0; i < tempList.size(); i++) {
                dcm_id=LevelRelationManagementDAO.ckDcmCodeExist(tempList.get(i));
                if(!dcm_id.equals("")){
                    LevelRelationManagementDAO.insertWarehouseToLevelZero(warehouse, dcm_id);
                }
