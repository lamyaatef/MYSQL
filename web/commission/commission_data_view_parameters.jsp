...
private void drawParameters(HttpServletRequest argRequest, HttpServletResponse argResponse, JspWriter argOut) throws IOException
{
    ...
    if(dataHashMap.containsKey(CommissionInterfaceKey.COMMISSION_DATA_VIEW_PARAMETER))
    {
    ...
    int rowPerPageForExcel = 65000;
        ...
        {  
            ...
            argOut.println("document.ReportParameters."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+CommissionInterfaceKey.ACTION_COMMISSION_SAVE_NEW_COMMISSION_NO_PARAM+"';");            
        ...
        {
            argOut.println("<CENTER>");
            argOut.println("<H2>  Commission Data View Parameters </H2>");
            argOut.println("</CENTER>");
            argOut.println("<script>");
            argOut.println("document.ReportParameters."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+CommissionInterfaceKey.ACTION_COMMISSION_SAVE_NEW_COMMISSION_PARAM+"';");               
            argOut.println("document.ReportParameters."+ReportInterfaceKey.PARAM_PREVIEW_REPORT_PARAMS_NUM+".value='"+colParameters.size()+"';");
            argOut.println("</script>");
...
<html>
 ...
 <%
    ...
    String commissionID = (String)dataHashMap.get(CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID);
    String dataViewType = (String)dataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_DATA_VIEW_TYPE);
...
out.println("<input type=\"hidden\" name=\""+CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_DATA_VIEW_TYPE+"\""+
                  " value=\""+dataViewType+"\">");
