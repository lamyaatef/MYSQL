...
<body>
    ...
    <%
        ...
        Vector commissionStatus = (Vector) objDataHashMap.get(CommissionInterfaceKey.VECTOR_COMMISSION_STATUS);
        Vector comChannelVec = (Vector) objDataHashMap.get(InterfaceKey.HASHMAP_KEY_ADDITIONAL_COLLECTION);
        Vector SearchResults = null;
        if (objDataHashMap.containsKey(CommissionInterfaceKey.VECTOR_COMMISSION_SEARCH_RESULT))
                    ;
        SearchResults = (Vector) objDataHashMap.get(CommissionInterfaceKey.VECTOR_COMMISSION_SEARCH_RESULT);

        String incomingAction = (String) objDataHashMap.get(InterfaceKey.HASHMAP_KEY_ACTION);

        String commissionAction = (String) objDataHashMap.get(CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ACTION);
        String hiddenCommissionStatus = (String) objDataHashMap.get(CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_STATUS);
        ...
        savedCommissionId = (String) objDataHashMap.get(CommissionInterfaceKey.SAVED_COMMISSION_ID);


        if (objDataHashMap.containsKey(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_NAME)) {
            commissionName = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_NAME);
            commissionId = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_ID);
            commissionSearchStatus = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_STATUS);
            commissionChannel = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_CHANNEL);
            commissionType = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_TYPE);
            commissionTypeCategory = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_CATEGORY);
            commissionStartDateFrom = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_START_DATE_FROM);
            commissionStartDateTo = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_START_DATE_TO);
            commissionEndDateFrom = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_END_DATE_FROM);
            commissionEndDateTo = (String) objDataHashMap.get(CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_END_DATE_TO);
...
<form name="COMform" action="" method="post">
    ...
    <table style="BORDER-COLLAPSE: collapse" width="100%" border="1"
            ...
            <td class="TableTextNote" align="center"><select
                    ...
                    <%
                        for (int i = 0; i < commissionStatus.size(); i++) {
                            GenericModel commissionStatusModel = (GenericModel) commissionStatus.get(i);
                            String selected = "";

                            if (!commissionStatusModel.get_field_2_value().equals("Deleted")) {
                                Utility.logger.debug(commissionStatusModel.get_field_2_value());
        ...
        <tr>
            <td height="27" class="TableTextNote" align="center">Commission
                Start Date From</td>
            <td class="TableTextNote" align="center"><script>drawCalender('<%=CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_START_DATE_FROM%>' , "<%=commissionStartDateFrom%>");</script></td>
            <td class="TableTextNote" align="center">Commission Start Date To</td>
            <td class="TableTextNote" align="center"><script>drawCalender('<%=CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_START_DATE_TO%>' , "<%=commissionStartDateTo%>");</script></td>
        </tr>
        <tr>
            <td height="27" class="TableTextNote" align="center">Commission
                End Date From</td>
            <td class="TableTextNote" align="center"><script>drawCalender('<%=CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_END_DATE_FROM%>' , "<%=commissionEndDateFrom%>");</script></td>
            <td class="TableTextNote" align="center">Commission End Date To</td>
            <td class="TableTextNote" align="center"><script>drawCalender('<%=CommissionInterfaceKey.CONTROL_TEXT_COMMISSION_END_DATE_TO%>' , "<%=commissionEndDateTo%>");</script></td>
        </tr>

        <tr>
            <td colspan="6" align="center">
                <%
                    out.println("<input name=\"Button\" type=\"button\" class=\"button\" value=\"Search\" onclick=\"document.COMform."
    ...
    <table style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
        <%
            for (int i = 0; i < SearchResults.size(); i++) {
                CommissionModel commissionModel = (CommissionModel) SearchResults.get(i);
                if (!commissionModel.getCommissionStatusTypeName().equals(
                        "Deleted")) {
                    int preChannelId = 0;
                    if (i != 0) {
                        preChannelId = ((CommissionModel) SearchResults.get(i - 1)).getCommissionChannelId();
                    }
                ...
                <div style="DISPLAY: none" id="<% out.print(channelId);%>" name=<%out.print(" " + channelName);%>>
                    <table style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1 class="<% out.print(InterfaceKey.STYLE[i % 2]);%>" id="CommissionTable">
                        ...
                        <tr class=TableHeader>
                            ...
                            <%
                                if (!commissionAction.equals(CommissionInterfaceKey.INPUT_HIDDEN_ALL_COMMISSION)) {
                            %>
                            <td nowrap align=middle>Review</td>
                            ...
                            <td nowrap align=middle>Details</td>                
                            <%
                                }
                            %>
                        </tr>
                        ...
                        <%
                                    ...
                                    out.println("<td  class=" + InterfaceKey.STYLE[i % 2] + ">"
                                            + commissionModel.getCommissionTypeCategoryName()
                                            + "</td>");
                                    ...
                                    out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\"Review\" onclick=\""
                                            + "document.COMform."
                                            + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                            + ".value='"
                                            + commissionModel.getCommissionID()
                                            + "';"
                                            + "document.COMform."
                                            + InterfaceKey.HASHMAP_KEY_ACTION
                                            + ".value='"
                                            + CommissionIIIInterfaceKey.ACTION_REVIEW_COMMISSION
                                            + "';"
                                            + "COMform.submit();\"/></td>");


                                    if (!commissionAction.equals(CommissionInterfaceKey.INPUT_HIDDEN_ALL_COMMISSION)) {
                                        if (hiddenCommissionStatus.equals(String.valueOf(commissionModel.getCommissionStatusTypeID()))) {
                                            Utility.logger.debug(hiddenCommissionStatus);


                                            if (userPerVector.contains(Integer.parseInt(strUserID))) {

                                                out.println("<td  align=\"center\"><input disabled name=\"Submit\" type=\"button\" class=\"button\" value=\"Delete\" onclick=\""
                                                        + "document.COMform."
                                                        + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                                        + ".value='"
                                                        + commissionModel.getCommissionID()
                                                ...
                                                out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\"Delete\" onclick=\""
                                                        + "document.COMform."
                                                        + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                                        + ".value='"
                                                        + commissionModel.getCommissionID()
                                            ...
                                            out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\""
                                                    + commissionAction
                                                    + "\" onclick=\""
                                                    + "document.COMform."
                                                    + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                            ...
                                            if (!hiddenCommissionStatus.equals("1")) {
                                                if (hiddenCommissionStatus.equals("2")) {
                                                    out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\"Factors\" onclick=\""
                                                            + "document.COMform."
                                                            + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                                            + ".value='"
                                                            + commissionModel.getCommissionID()
                                                ...
                                                out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\"Export\" onclick=\""
                                                        + "document.COMform."
                                                        + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                                        + ".value='"
                                                        + commissionModel.getCommissionID()
                                                        ...
                                                        + "';"
                                                        + "COMform.submit();\"/></td>");
                                                out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\"View\" onclick=\""
                                                        + "document.COMform."
                                                        + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                                        + ".value='"
                                                        + commissionModel.getCommissionID()
                                                ...
                                                if (hiddenCommissionStatus.equals("2")
                                                        || hiddenCommissionStatus.equals("3")) {
                                                    addDetailsButton(out, commissionModel);
                                                }
                    ...
                    <table style="BORDER-COLLAPSE: collapse" width="100%" border="0"
                        ...
                        <tr>
                            <td colspan="1" align='center'>
                                <%
                                    out.println("<input type='button' class='button' name='newcommission' value='Create New Commission' onclick=\"document.COMform."
                                            + InterfaceKey.HASHMAP_KEY_ACTION
                                            + ".value='"
                    ...
                    <%! private void addDetailsButton(JspWriter out, CommissionModel commissionModel) {
                            try {
                                out.println("<td  align=\"center\"><input name=\"Submit\" type=\"button\" class=\"button\" value=\"DP detail\" onclick=\""
                                        + "document.COMform."
                                        + CommissionInterfaceKey.INPUT_HIDDEN_COMMISSION_ID
                                        + ".value='"
                                        + commissionModel.getCommissionID()
                                        ...
                                        + InterfaceKey.HASHMAP_KEY_ACTION
                                        + ".value='"
                                        + CommissionInterfaceKey.ACTION_VIEW_DRIVING_PLAN_COMMISSION_DETAIL
                                        + "';"
                                        + "COMform.submit();\"/></td>");
