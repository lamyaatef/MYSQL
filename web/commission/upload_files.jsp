...
function submitForm()
{
    ...
    var fileName = document.COMform.file.value;
    if(fileName == "")
    {
...
%>
<table style="BORDER-COLLAPSE: collapse" width="40%" border="1" align="center" cellpadding="0" cellspacing="1">
<tr>
...
<tr>
<td class=TableHeader>Zipped</td>
<td ><input type="checkbox" name="zippedornot"></td>
</tr>
<tr>

<td align="center" colspan="2">
<%
  out.println("<input type=\"button\" name=\"button1\" id=\"button1\" value=\"Submit your file\" class=\"button\" onclick=\""+
