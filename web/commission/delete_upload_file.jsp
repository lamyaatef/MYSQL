...
<HTML>
   <HEAD>
      ...
      <TITLE>Upload DCM Data</TITLE>
      <center>
      <h2>Upload DCM Data</h2>
      </center>
   </HEAD>
...
String appName = request.getContextPath();
    ...
    System.out.println("The label Id issssssssss " + labelId);

    String formAction = appName +"/servlet/com.mobinil.sds.web.controller.WebControllerServlet?"
                    +InterfaceKey.HASHMAP_KEY_ACTION+"="
                    +CommissionInterfaceKey.ACTION_DELETE_UPLOAD_FILE_PROCESS+
                    "&"+InterfaceKey.HASHMAP_KEY_USER_ID+"="
                    +strUserID+
                    "&"+CommissionInterfaceKey.INPUT_HIDDEN_LABEL_ID+"="
                    +labelId;
