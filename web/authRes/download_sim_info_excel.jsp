...
<html>
    ...
    String fileName = (String) dataHashMap.get(AuthResInterfaceKey.SIM_INFO_FILE_DOWNLOAD_PATH);
    
dataHashMap.put(InterfaceKey.EXPORT_FILE_PATH, fileName);
dataHashMap.put(InterfaceKey.MODULE_SUB_PATH, "authRes"+Slach+"uploadtext"+Slach);
