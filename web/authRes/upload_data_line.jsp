<%-- 
    Document   : upload_data_line
    Created on : Jan 24, 2012, 12:58:20 PM
    Author     : mabdelaal
--%>
...
<html>
    <head>
        ...
        <title>Data Line File Upload</title>
    </head>
    <%
        ...
        <form name="uploadform" id="uploadform" action="" method="POST" enctype="multipart/form-data">
            <table style="BORDER-COLLAPSE: collapse" width="60%" border="1" align="center" cellpadding="0" cellspacing="1">
                ...
                <td class=TableHeader width="80%">                        
                    ...
                    <input type="hidden" name="<%=AuthResInterfaceKey.CONTROL_HIDDEN_UPLOAD_FILE_TYPE_ID %>" id="<%=AuthResInterfaceKey.CONTROL_HIDDEN_UPLOAD_FILE_TYPE_ID %>" value="3"/>
        </form>
        <script>
            <%if (errorMsg!=null) out.println("alert('"+errorMsg+"')");%>
                        function checkBeforeSubmit(){                            
                            ...
                            if (msg!="")
                                ...
                                {
                                 actionStr += '<%=InterfaceKey.HASHMAP_KEY_ACTION%>=<%=AuthResInterfaceKey.ACTION_UPLOAD_DATA_LINE_PROCESS %>';
                                actionStr +='&';                            
