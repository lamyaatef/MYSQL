...
%>    <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
      ...
      <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
        ...
        <TR class=TableTextNote>
          ...
          <td align='center'>
        <%
        out.print("<INPUT class=button type=button value=\" Edit \" name=\"edit\" id=\"edit\" onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_EDIT_PENDING_SHEET+"';"+
                          "document.SFRform."+SFRInterfaceKey.INPUT_HIDDEN_SHEET_SERIAL+".value = '"+sheetSerial+"';"+
        ...
        %>
          ...
          <td align='center'>
        <%
        out.print("<INPUT class=button type=button value=\" Delete \" name=\"delete\" id=\"delete\" onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_DELETE_PENDING_SHEET+"';"+
                          "document.SFRform."+SFRInterfaceKey.INPUT_HIDDEN_SHEET_SERIAL+".value = '"+sheetSerial+"';"+
                          "document.SFRform."+SFRInterfaceKey.INPUT_HIDDEN_SHEET_ID+".value = '"+sheetId+"';SFRform.submit();\">");          
        %>
          </td>
