...
String msg=(String)dataHashMap.get(SFRInterfaceKey.CONTROL_HIDDEN_MSG);                      
...
{
	if (IsNumeric(document.getElementById('<%=SFRInterfaceKey.CONTROL_HIDDEN_BATCH_ID%>').value)== false) {
		alert("characters is not allowed");
	}else{
	document.getElementById('<%=InterfaceKey.HASHMAP_KEY_ACTION%>').value='<%=SFRInterfaceKey.ACTION_DELETE_BATCH%>';
...
<%@page import="com.mobinil.sds.web.interfaces.sfr.SFRInterfaceKey"%><html>
    ...
    <body>
        ...
        <form action="<%=appName%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet" name="<%=formName%>" method="post">
            ...
            <%if(action.compareTo(SFRInterfaceKey.ACTION_DELETE_BATCH)==0){
            ...
            <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing="2" cellPadding="1" width="100%" border="1">
              ...
              <tr>
              <td>Batch ID</td>
              <td><input type="text" name="<%=SFRInterfaceKey.CONTROL_HIDDEN_BATCH_ID%>" id="<%=ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID%>"></td>
              </tr>
              <tr>
