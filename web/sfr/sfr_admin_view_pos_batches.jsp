...
<script>
  ...
  Utility.logger.debug("The Row num issssssssssssssssssssss " + rowNum);
  ...
  %>  
      ...
      <tr>
        ...
        <%
        out.print("<INPUT class=button type=button value=\" Search \" name=\"searchrequest\" id=\"searchrequest\" onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_ADMIN_SEARCH_BATCHES+"';SFRform.submit();\">");
...
<%
        ...
        //int checkStatus = batchModel.getCheckStatus();
...
%>
        <TR class=<%=InterfaceKey.STYLE[i%2]%>>
          <td align='center'>
            <%
              out.println("<A href=\"#\" onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_ADMIN_VIEW_BATCH_SHEETS+"';"+
          ...
          <td align='center'>
            ...
            if(batchSuggestedStatusId.compareTo(SFRInterfaceKey.CONST_BATCH_STATUS_TYPE_CLOSED)==0 && batchStatusTypeId.compareTo(SFRInterfaceKey.CONST_BATCH_STATUS_TYPE_ACCEPTED)==0)
            {
              out.println("<input type='button' class='button' name='"+SFRInterfaceKey.INPUT_SELECT_BATCH_STATUS_ID+"_"+batchId+"' id='"+SFRInterfaceKey.INPUT_SELECT_BATCH_STATUS_ID+"_"+batchId+"' value='Close' "+
                          "onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_ADMIN_UPDATE_BATCH_STATUS+"';"+
...
Utility.logger.debug("The total rows issssssssssss " + totalRows);
  ...
  if(rowNum>=1)
  {
    ...
    out.println("<td align = 'right'><INPUT id=button4 class=button type=button value=\"<<\" name=button3 onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_PREVIOUS_ADMIN_SEARCH_BATCHES+"';"+"document.SFRform.submit();\">");
  }
  else
  {
  ...
  if(batches.size()>=30&&totalRows!=count)
  {
    ...
    out.println("<INPUT id=button3 class=button type=button value=\">>\" name=button3 onclick=\"document.SFRform."+InterfaceKey.HASHMAP_KEY_ACTION+".value = '"+SFRInterfaceKey.ACTION_NEXT_ADMIN_SEARCH_BATCHES+"';"+"document.SFRform.submit();\"></td>");
  }
  else
  {
