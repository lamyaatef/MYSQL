...
<html>
  ...
  //Number("+ argControlName + ".RowSet.getRowCount())
    ...
    function app_need_removeRows(argObject,showMsg)
    {
    if(showMsg)
    {
    ...
    {
      document.SFRform.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value = '<%=SFRInterfaceKey.ACTION_ADMIN_SAVE_SHEET_CONTRACTS_SIM_NUMBER%>';
  ...
  String sheetStatusTypeId = (String)objDataHashMap.get(SFRInterfaceKey.INPUT_HIDDEN_SHEET_STATUS_TYPE_ID);
    ...
    for(int i=0;i<SIMList.size();i++)
    {
      ...
      out.println("eval(\"document.SFRform.user_defined_data_view__R"+rowIndex+"__C4.value = '"+simStatusTypeName+"';\"); ");
