...
<SCRIPT language="javascript">
 ...
 function addYear()
 {
	document.SFRform.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value = '<%=SFRInterfaceKey.ACTION_ADD_YEAR%>';
	SFRform.submit();
 }
 ...
 function closeAndOpenMonth(year , month ,  status , statusId)
 {
	...
	document.SFRform.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value = '<%=SFRInterfaceKey.ACTION_CLOSE_MONTH_COMMISSION%>';
	SFRform.submit();
 }
