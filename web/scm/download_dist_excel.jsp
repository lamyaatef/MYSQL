...
<html>
    ...
    STKDistRequestViewerDTO excelModel=(STKDistRequestViewerDTO)dataHashMap.get(SCMInterfaceKey.MODEL_DIST_REQUEST_STATICTIS);        
Blob blob = excelModel.getStkDistRequestModel().getREQUEST_FILE();
