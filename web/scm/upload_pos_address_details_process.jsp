<%-- 
    Document   : upload_pos_address_details_process
    Created on : Dec 19, 2012, 7:16:41 PM
    Author     : sand
--%>

<%@page import="com.mobinil.sds.core.system.scm.model.PosDetailAddressModel"%>
<%@page import="com.mobinil.sds.core.system.scm.model.GenDcmAddressModel"%>
...
<%
    ...
    POSDAO.deleteTmpAddressGenDcm(con);
    POSDAO.deleteTmpAddressPosDetail(con);


    Vector vecGenDcm = null;
    Vector vecDcmPosDetail = null;
    ...
    POSDAO.getTmpAddressGenDcm(con);

    POSDAO.getTmpAddressPosDetail(con);
