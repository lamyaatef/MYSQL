...
<html>
  ...
  String strUserID = (String)dataHashMap.get(InterfaceKey.HASHMAP_KEY_USER_ID);
   ...
   String dateFrom =(String)dataHashMap.get(SCMInterfaceKey.CONTROL_TEXT_GENERATE_DCM_TEMPLATE_FROM);
   String dateTo =(String)dataHashMap.get(SCMInterfaceKey.CONTROL_TEXT_GENERATE_DCM_TEMPLATE_TO);
%>
   <center>
...
<%DistributerSTKDataDAO.activeSTKsForValidDistributers(dateFrom,dateTo);%>
</body>
</html>