...
<html>
  ...
  <body>
    ...
    {
        document.write("<INPUT value="+argValue+" class=input readOnly name=\""+argOrder+"\">&nbsp;<A onclick=\"showCalendar(SCMform."+argOrder+",'dd/mm/yyyy','Choose date')\">");
...
<form name='SCMform' id='SCMform' action='<%=action%>' method='post'>
  ...
  out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+
                  " value=\""+SCMInterfaceKey.ACTION_POS_EXPORT_EXCEL_MANAGEMENT +"\">");
