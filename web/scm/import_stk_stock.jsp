...
<HTML>
   ...
   <br>
   <br>
   <h2 align="center">Import STKs Stock Management</h2>
   <br>
   <br>
<script>
function submitForm()
...
%>
   ...
   <% out.println("<input type=hidden name="+SCMInterfaceKey.CONTROL_IMPORT_OPERATION+" value="+SCMInterfaceKey.INSERT_OPERATION+" >");%>
