  ...
  <body>
    <center>
      <%   
        ...
        String templatePath = request.getRealPath("/scm/template/");
      System.out.println("before the export");
        gen.exportPaymentLevelTemplate(templatePath+"/template.xls",templatePath+"/generated.xls") ;
        System.out.println("after the export");
        System.out.print(appName);
        //java.io.File f = new java.io.File("def.xls");
        // out.println(f.exists());
        out.println("<form action=\""+appName+"/scm/template/generated.xls\" name=\"GenerateSheet\" method=\"post\">");
