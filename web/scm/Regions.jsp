...
<%
    ...
    int managerid2 = 0;//(request.getParameter("managerid2")==null || request.getParameter("managerid2").compareTo("")==0) ? -1 : Integer.parseInt(request.getParameter("managerid2"));
    int userLevelId = 0;//(request.getParameter("userLevel")==null || request.getParameter("userLevel").compareTo("")==0) ? -1 : Integer.parseInt(request.getParameter("userLevel"));
    int supervisor=-1;
    int teamleader=-1;
    int salesrep=-1;
