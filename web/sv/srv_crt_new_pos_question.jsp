...
function IsNumeric(sText)
{
  ...
  <body>
  <Center><h2> Create POS Questions</h2></center>
<%                
  ...
  String strGroupType = (String) objDataHashMap.get(SurveyInterfaceKey.INPUT_HIDDEN_GROUP_TYPE_ID);
  ...
  QuestionAction = SurveyInterfaceKey.ACTION_SRV_SAVE_POS_QUESTION;
...
<%
  ...
  out.println("<input type=\"hidden\" name=\""+SurveyInterfaceKey.INPUT_HIDDEN_GROUP_TYPE_ID+"\""+
                  " value=\""+strGroupType+"\">");                 
      ...
      <TABLE border=0 align='center' width='100%'>
        ...
        <!--TR class=TableHeader>
          ...
          <TD class=TableHeader colSpan=4-->
              ...
              <%
              Utility.logger.debug("sssss"+ strGroupType);
              for (int i=0; i<vecQuestionCategoryList.size(); i++)
              {
                  ...
                  if(XquestionCategoryId.equals(strGroupType))
                  {
