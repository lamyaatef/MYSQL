...
String jobId=(String)request.getParameter(IFReportDeliveryInterfaceKey.CONTROL_JOB_ID);
System.out.println("job Id: "+jobId);
//int jobId=IFReportDeliveyDao.createNewJob(userID,reportDate);

//IFReportDeliveyDao.completeInfofortDataTable(jobId);
IFDataComparator dc=new IFDataComparator(Integer.parseInt(jobId),1);
dc.start();
