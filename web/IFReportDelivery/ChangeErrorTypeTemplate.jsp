...
<%@page import="com.mobinil.sds.core.system.ifReportDelivery.dao.IFReportDeliveyDao"%><html>
  ...
  <body>
    <center>
	  ...
	  IFReportDeliveyDao.generateChangeTypeTemplate(templatePath+"/change type template.xls",templatePath+"/template");
	  out.println("<form action=\""+appName+"/IFReportDelivery/template/"+"template"+".xls\" name=\"GenerateSheet\" method=\"post\">");
