...
try{
  ...
  Vector vecTaskList = (Vector) objDataHashMap.get("nomad_task_vec") ;//TaskInterfaceKey.VEC_NOMAD_TASKS
 // System.out.println("vecTaskList in jsp : "+vecTaskList);
  if (vecTaskList ==null)
  {
    return;
  }
...
out.println("</TR></thead><tbody>");
  ...
  for (int i=0; i<taskListSize; i++)
  {
    ...
    NomadTaskDTO taskDTO =  (NomadTaskDTO) vecTaskList.elementAt (i);    
 ...
 /*   if(taskDTO.getTaskCurrentStatusId()==3){
    ...
    updatedRows=ntraTaskDTO.getUpdatedRows();
      }
      }      */    
