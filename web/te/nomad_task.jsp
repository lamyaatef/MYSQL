...
+TaskInterfaceKey.ACTION_SAVE_NOMAD_TASK +"&"+InterfaceKey.HASHMAP_KEY_USER_ID+"="
+USER_ID;
%>
    <body>
        <center>
        <h2>Create Nomad Task</h2>
        ...
        <form name="create" action="<%=formAction%>" method="post" >
            ...
            <td>Task Name</td>
            <td>
            <input type="text" name="<%=TaskInterfaceKey.CONTROL_NOMAD_TASK_NAME%>">
            </td>
            </tr>
            </table>
            <br>
