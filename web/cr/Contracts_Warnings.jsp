  ...
  throws ServletException, IOException
  {
    ...
    if(dataHashMap != null)
    {
      if(! dataHashMap.isEmpty())
      {
        ...
        out.print("onclick=\"document.ContractWarnings."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_UPDATE_CONTRACT_WARNINGS_STATUSES+"';ContractWarnings.submit();\" disabled>");
        out.println("</td>"); 
        out.println("</tr>"); 
        out.println("</table>"); 
      }
