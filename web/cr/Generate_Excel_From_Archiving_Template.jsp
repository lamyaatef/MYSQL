  ...
  <body>
    <center>
      <%   
        ...
        String templatePath = request.getRealPath("/cr/TemplateArchiving/");
        gen.exportTemplateArchiving(templatePath+"template.xls",templatePath+"generated.xls") ;
        //java.io.File f = new java.io.File("def.xls");
        // out.println(f.exists());
        out.println("<form action=\""+appName+"/cr/TemplateArchiving/generated.xls\" name=\"GenerateSheet\" method=\"post\">");
