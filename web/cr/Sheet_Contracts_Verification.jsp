...
<SCRIPT language=JavaScript>
  ...
  function checkWarningBeforSubmit()
  {
    ...
    var reimportedflag = document.ContractDetails.ReimpotedContractFlag.value ;

    if (reimportedflag =='true')
    {
      return;
    }
...
*/
  ...
  throws ServletException, IOException
  {
    ...
    String action = (String)request.getAttribute(InterfaceKey.HASHMAP_KEY_ACTION);  
    dataHashMap = (HashMap)request.getAttribute(InterfaceKey.HASHMAP_KEY_DTO_OBJECT);
    if (action.compareTo(ContractRegistrationInterfaceKey.ACTION_VERIFY_CONTRACT)!=0) {
      out.println("<body onload=\"document.ContractVerify."+ContractRegistrationInterfaceKey.CONTROL_TEXT_CONTRACT_SIM_NO+".focus();\""+
                     "onkeypress = \"if(event.keyCode==13){checkbeforSubmit();}\">");
    }
    else {
      out.println("<body onkeypress = \"if(event.keyCode==13){checkWarningBeforSubmit();}\">");
    }
    ...
    if(dataHashMap != null)
    {
      if(! dataHashMap.isEmpty())
      {
        ...
        out.println("<form action=\""+appName+"/servlet/com.mobinil.sds.web.controller.WebControllerServlet\" name=\"ContractVerify\" method=\"post\">");
        ...
        out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+
                    "\" value=\""+ContractRegistrationInterfaceKey.ACTION_VERIFY_CONTRACT+"\">");

        out.println("<input type=\"hidden\" name=\""+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_PHASE_NAME+
                    "\" value=\""+ContractRegistrationInterfaceKey.CONTRACT_VERIFICATION_PHASE+"\">");
        ...
        if(strError != null && action.compareTo(ContractRegistrationInterfaceKey.ACTION_VERIFY_SHEET)==0)
        {
          out.println("<script type=\"text/javascript\">");
          out.println("alert('"+strError+"');");
          out.println("document.ContractVerify."+InterfaceKey.HASHMAP_KEY_ACTION+
                      ".value=\""+ContractRegistrationInterfaceKey.ACTION_SHOW_BATCH_DETAILS_CONTRACT_VERIFICATION+"\";");
          out.println("ContractVerify.submit();");
          out.println("</script>");
        }
        else
        {
          ...
          out.println("<Center>");
          out.println("<H2>Contract Verification</H2>");
          out.println("</Center>");
          out.println("<left>");
          out.println("<h3>Contract Verification</h3>");
          out.println("</left>");
          out.println("<Center>");
          ...
          out.println("<td align=center><font size=2>Batch ID</font></TD>");      
          ...
          out.println("<TR>");
          out.println("<td nowrap align=center>"+batchID+"</td>");
          out.println("<td nowrap align=center>"+sheetSerialNumber+"</td>");
          ...
          out.println("<td nowrap>"+sheetStatus+"</td>");
          ...
          if(action.compareTo(ContractRegistrationInterfaceKey.ACTION_VERIFY_CONTRACT)!=0)
          {
            ...
            out.println("Contract Main Sim No");
            out.println("<input type=\"text\" name=\""+ContractRegistrationInterfaceKey.CONTROL_TEXT_CONTRACT_SIM_NO+"\" "+
                        "size=\"21\" maxlength=\"20\" value=\""+contractSimNo+"\">");
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td align=center>");
            out.println("<input class=\"button\" type=\"button\" name=\"verify\" value=\"  Verify  \" "); 
            out.println("onclick=\"checkbeforSubmit();\">");
            out.println("<input class=button type=\"button\" name=\"back\" value=\"   Back   \" ");
            out.println("onclick=\"document.ContractVerify."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+
                        ContractRegistrationInterfaceKey.ACTION_SHOW_BATCH_DETAILS_CONTRACT_VERIFICATION+"';"+
                        "ContractVerify.submit();\">");
            out.println("</td>");
            out.println("</tr>");
            out.println("</table>");
          }
  ...
  throws ServletException, IOException
  {
    ...
    if(dataHashMap != null)
    {
      if(! dataHashMap.isEmpty())
      {
        ...
        out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+
                    " value=\""+ContractRegistrationInterfaceKey.ACTION_UPDATE_CONTRACT+"\">");
        ...
        else
        {
          ...
          out.println("<TD valign = \"top\">");
              ...
              */
              out.println("<select  size=\"10\" multiple name=\""+ContractRegistrationInterfaceKey.CONTROL_SELECT_SYSTEM_WARNINGS+"\" id=\""+ContractRegistrationInterfaceKey.CONTROL_SELECT_SYSTEM_WARNINGS+"\" style=\"display:none\">");
              for(int i=0; i<systemWarning.size(); i++)
              {
                ContractWarningModel contractWarningModel = (ContractWarningModel)systemWarning.elementAt(i);
              ...
              out.println("<TR >");
              out.println("<td class=TableHeader nowrap><font size=2></font></TD>");      
              out.println("<td width=\"5%\" colspan=2>");
              out.println("<select name=\""+ContractRegistrationInterfaceKey.CONTROL_SELECT_CONTRACT_STATUS +"\" size=\"1\" style=\"display:none\"");
              ...
              out.println("<input type=\"hidden\" name=\""+"ReimpotedContractFlag"+
              "\" value=\""+contractModel.getReImportedFlag()+"\">");
              ...
              out.println("<input class=\"button\" type=\"button\" name=\"cancel\" value=\"  Cancel  \""+
                          " onclick=\"document.ContractDetails."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+
                          ContractRegistrationInterfaceKey.ACTION_VERIFY_SHEET+"';"+
          ...
          out.println("<TD>");
              ...
              out.println("<input class=\"button\" type=\"button\" name=\"recheckSystemWarning\" value=\"  Recheck System Warning  \""+
                          " onclick=\"document.ContractDetails."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+
                          ContractRegistrationInterfaceKey.ACTION_RECHECK_CONTRACT_SYSTEM_WARNING+"';"+
                          "ContractDetails.submit();\">");          
