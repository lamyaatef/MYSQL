...
if(jobId != null)
{
  ...
  if(workerHashMap == null)
  {
      ...
      out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+
                    " value=\""+ContractRegistrationInterfaceKey.ACTION_IMPORT_EXCEL_FROM_ARCHIVING_PROCESS+"\">");
...
printToStream("</script>",out,pw);  
  ...
  ImportArchivingWorker iaWorker = new ImportArchivingWorker(tableId,operation,strUserID,batchId,reportImport);
