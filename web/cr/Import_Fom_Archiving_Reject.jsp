...
function submitForm()
{
  ...
  document.myform.action = document.myform.action+'&'+'<%out.print(AdministrationInterfaceKey.QUERY_STRING_TABLES+"");%>='+"46"+'&'+'<%out.print(AdministrationInterfaceKey.QUERY_STRING_OPERATION+"=");%>'+"INSERT"
  document.myform.action = document.myform.action+'&'+'<%out.print(ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID+"=");%>'+"10";
...
String appName = request.getContextPath();
    ...
    String formAction = appName +"/servlet/com.mobinil.sds.web.controller.WebControllerServlet?"
                    ...
                    ContractRegistrationInterfaceKey.ACTION_IMPORT_EXCEL_FROM_ARCHIVING_PROCESS_REJECT
                    +
