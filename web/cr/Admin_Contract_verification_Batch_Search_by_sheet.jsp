  ...
  throws ServletException, IOException
  {
    ...
    if(dataHashMap.containsKey(InterfaceKey.HASHMAP_KEY_JOB_ID))
    {
      ...
      out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\""+
                    " value=\""+ContractRegistrationInterfaceKey.ACTION_ADMIN_OPEN_ARCHIVING_PROCESS_BY_SHEET+"\">");
    ...
    out.println("<Center>");
      out.println("<H2>Contract Verification Administration By Sheet</H2>");
    out.println("</Center>");
    ...
    out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\" value=\""+ContractRegistrationInterfaceKey.ACTION_ADMIN_SEARCH_BATCH_CONTRACT_VERIFICATION_BY_SHEET+"\">");
    ...
    if(dataVector != null && dataVector.size()!=0)
    {
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        "document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_ADMIN_SHOW_BATCH_DETAILS_CONTRACT_VERIFICATION_BY_SHEET+"';"+
        ...
        out.println("<td nowrap align=center>");
        if(batchStatus.compareTo(com.mobinil.sds.core.system.cr.batch.model.BatchModel.STATUS_OPEN_AUTHINTICATION)==0)
        {
        ...
        " onclick=\"document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_ADMIN_OPEN_ARCHIVING_PROCESS_BY_SHEET+"';"+
        " document.BatchPrint."+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID+".value="+batchID+";"+
        "document.BatchPrint."+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_ARCHIVING_FLAG+".value="+archivingFlag+";"+
        " BatchPrint.submit();\">");
        }
    ...
    else 
    {
      ...
      {
        if(((String)request.getAttribute(InterfaceKey.HASHMAP_KEY_ACTION)).compareTo(ContractRegistrationInterfaceKey.ACTION_ADMIN_SEARCH_BATCH_CONTRACT_VERIFICATION_BY_SHEET)==0)
        {
