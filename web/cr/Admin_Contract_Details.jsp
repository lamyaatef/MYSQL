...
<SCRIPT language=JavaScript>
  ...
  {
    document.ContractDetails.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value = "<%=ContractRegistrationInterfaceKey.ACTION_ADMIN_UPDATE_CONTRACT%>";
        ...
        //      out.println(contractModel.getContractFormNumber());
          ...
          out.println("<TD valign = \"top\">");
              ...
              */
              ...
              " onclick=\"document.ContractDetails."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_ADMIN_VERIFY_SHEET+"';ContractDetails.submit();\">");
