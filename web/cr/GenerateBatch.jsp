...
<form method="post" name="<%out.print(formName);%>" action="<%out.print(appName);%>/servlet/com.mobinil.sds.web.controller.WebControllerServlet?<%out.print(InterfaceKey.HASHMAP_KEY_ACTION+"="+ContractRegistrationInterfaceKey.ACTION_GENERATE_BATCH);%>">
<%
  HashMap dataHashMap = (HashMap)request.getAttribute(InterfaceKey.HASHMAP_KEY_DTO_OBJECT);
...
<tr>
    ...
    <input class="input"  name="<%=ContractRegistrationInterfaceKey.GENERATE_BATCH_DATE%>"  value="<%=curDate%>" Readonly>
