...
throws java.io.IOException
{
  ...
  */
  ...
  throws ServletException, IOException
  {
    ...
    out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\" value=\""+ContractRegistrationInterfaceKey.ACTION_SEARCH_BATCH_CONTRACT_VERIFICATION+"\">");
   ...
   //   out.println("<td nowrap align=middle>Authenticate</td></tr>");
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        "document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_SHOW_BATCH_DETAILS_CONTRACT_VERIFICATION+"';"+
        ...
        out.print("onclick=\"openWindowfull('"+appName+"/servlet/com.mobinil.sds.web.controller.WebControllerServlet?"+
                  ...
                  ContractRegistrationInterfaceKey.CONTROL_HIDDEN_ARCHIVING_FLAG+"=,"+archivingFlag+"');return false;\"></td>");
/*
        ...
        if(batchStatus.compareTo(com.mobinil.sds.core.system.cr.batch.model.BatchModel.STATUS_OPEN_AUTHINTICATION)==0)
        {
          ...
          " onclick=\"document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_AUTHINTICATE_BATCH_CONTRACT_VERIFICATION+"';"+
          " document.BatchPrint."+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID+".value="+batchID+";"+
    ...
    else 
    {
      ...
      {
        if(((String)request.getAttribute(InterfaceKey.HASHMAP_KEY_ACTION)).compareTo(ContractRegistrationInterfaceKey.ACTION_SEARCH_BATCH_CONTRACT_VERIFICATION)==0)
        {
