...
<SCRIPT language="javascript">
 ...
 function addYear()
 {
	document.SFRform.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value = '<%=ContractRegistrationInterfaceKey.ACTION_ADD_YEAR_CR%>';
	SFRform.submit();
 }
 ...
 function closeAndOpenMonth(year , month ,  status , statusId)
 {
	...
	document.SFRform.<%=InterfaceKey.HASHMAP_KEY_ACTION%>.value = '<%=ContractRegistrationInterfaceKey.ACTION_CLOSE_MONTH_COMMISSION_CR%>';
	SFRform.submit();
 }
