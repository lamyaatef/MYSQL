...
<html>
  ...
  <body onkeypress = "if(event.keyCode==13){checkbeforSubmit();}">
    <Center>
      <H2>Manage Batches Opened For Archiving</H2>
    </Center>
...
throws java.io.IOException
{
  ...
  */
  ...
  throws ServletException, IOException
  {
    ...
    out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_ACTION+"\" value=\""+ContractRegistrationInterfaceKey.ACTION_SEARCH_MANAGE_BATCH_OPENED_FOR_ARCHIVING+"\">");
    ...
    if(dataVector != null && dataVector.size()!=0)
    {
      ...
      out.println("<td align=middle>Generate Accepted Verify</td>");
      out.println("<td align=middle>Generate Rejected Verify</td></tr>");
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        if(archivingFlag.compareTo(ContractRegistrationInterfaceKey.CONST_ARCHIVING_FLAG_ENTERED_ARCHIVING_PROCESS)==0)
        {
        out.println("<TR>");
        ...
        out.println("<td align=center nowrap>"+batchID+"</td>");
        ...
        out.println("<td nowrap align='center'>");
        out.println("<input class=button type=\"button\" name=\"accepted\" value=\"Accepted\""+
          " onclick=\"document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_GENERATE_EXCEL_FOR_ACCEPTED_VERIFY+"';"+
          " document.BatchPrint."+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID+".value="+batchID+";"+
          " BatchPrint.submit();\">");
        out.println("</td>");
        
        out.println("<td nowrap align='center'>");
        out.println("<input class=button type=\"button\" name=\"rejected\" value=\"Rejected\""+
          " onclick=\"document.BatchPrint."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+ContractRegistrationInterfaceKey.ACTION_GENERATE_EXCEL_FOR_REJECTED_VERIFY+"';"+
          " document.BatchPrint."+ContractRegistrationInterfaceKey.CONTROL_HIDDEN_BATCH_ID+".value="+batchID+";"+
          " BatchPrint.submit();\">");
        out.println("</td>");
