 ...
 */ 
  ...
  String channelid =(String) dataHashMap .get(ContractRegistrationInterfaceKey.CONTROL_HIDDEN_CHANNEL_ID);
  String statement  = "";
  if (channelid.equals("1"))
	  ...
	  statement="Complemantry";
	  
  
%>

<%@page import="com.mobinil.sds.core.system.dcm.chain.model.chainChannelModel"%><html>
  <head>
  ...
  <body>
      ...
      <left>
       <h3>User <%=statement%> Management</h3>
      </left>
    </Center>
  ...
  throws ServletException, IOException
  {
    ...
    if(! dataHashMap.isEmpty())
    {
      ...
      for(int i = 0; i<dataVector.size(); i++)
      {
        ...
        out.print(" value=\""+ContractRegistrationInterfaceKey.ACTION_UPDATE_USER_DCM+"\">");
        ...
        if(channelId.equals("2")){
            out.println("<TR class=TableHeader><td colspan=3 nowrap align=middle>"+personName+" Franchises</td></tr>");}
        if(channelId.equals("3")){
            out.println("<TR class=TableHeader><td colspan=3 nowrap align=middle>"+personName+" Complementaries</td></tr>");}
        out.println("<TR class=TableHeader>");
        if(channelId.equals("1")){
        out.println("<td width=\"40%\" nowrap align=middle>DCM Name</td>");
        out.println("<td width=\"40%\" nowrap align=middle>DCM Code</td>");}
        if(channelId.equals("2")){
        out.println("<td width=\"40%\" nowrap align=middle>Franchise Name</td>");
        out.println("<td width=\"40%\" nowrap align=middle>Franchise Code</td>");}
        if(channelId.equals("3")){
        out.println("<td width=\"40%\" nowrap align=middle>Complementary Name</td>");
        out.println("<td width=\"40%\" nowrap align=middle>Complementary Code</td>");}
