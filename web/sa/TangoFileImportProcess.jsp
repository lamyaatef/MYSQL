...
<%@page import="com.mobinil.sds.core.system.tango.dao.TangoFileDAO"%>
...
//TangoFileDAO.updateNomadFile(nomadFileId, nomadImporterObj.getNumberOfRowsInserted()/*, tableId*/);
