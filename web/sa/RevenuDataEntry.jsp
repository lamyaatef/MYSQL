...
<%
   ...
   out.println("<input type=\"hidden\" name=\""+InterfaceKey.HASHMAP_KEY_USER_ID+"\" "+
    ...
    AdministrationInterfaceKey.ACTION_SEARCH_REVENUE+"'; document.SheetRevenue.submit(); } else alert('Please Enter A Valid Year');\">");
    ...
    if (dcmDto!=null)
    {
      ...
      for (int i = 0 ; i <dcmDto.getDcmModelsSize();i++)
      {
        ...
        RevenueModel revenueModel = (RevenueModel) revenueTable.get(model.getDcmId()+"");
        String value ="";
        String revenueId = "";
        ...
        {
          value=revenueModel.getAmount() +"";
         revenueId =  revenueModel.getRowID();
        }
        
        out.println("<td nowrap align=center>");
        
        out.println("<input type=\"HIDDEN\" name=\""+AdministrationInterfaceKey.CONTROL_INPUT_REVENUE_ID+"\" value=\""+revenueId+"\">");        out.println("<input type=\"HIDDEN\" name=\""+AdministrationInterfaceKey.CONTROL_INPUT_DCM_ID+"\" value=\""+model.getDcmId()+"\">");
      ...
      out.print("onclick=\"if (checkBeforeUpdate()) {document.SheetRevenue."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+
      AdministrationInterfaceKey.ACTION_UPDATE_REVENUE+"'; document.SheetRevenue.submit();} else {alert('one or more data entry value is Invalid');} \">");
