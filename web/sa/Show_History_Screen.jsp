    ...
    <body>
        <form  name='AUTHform' id='AUTHform' action='' method='post'>  
            <%
                ...
                //lamya
                String nextAction2 = "";
                nextAction1 = AdministrationInterfaceKey.ACTION_EXPORT_PAYMENT_LEVEL_HISTORY;
            ...
            %>  
            <CENTER>
                <H2>Show Payment Level History File </H2>
            </CENTER>
            ...
            <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
                <TR class=TableHeader>
                    ...
                    <td width="20%" nowrap align=middle>Channel Name</td>
                    <td width="30%" nowrap align=middle>Payment Level Name</td>
                ...
                <%
                    ...
                    for (int i = 0; i < files.size(); i++) {
                        PaymentHistoryFileModel model = (PaymentHistoryFileModel) files.get(i);
                        ...
                        Status = model.getFILE_STATUS();
                        ChannelName = model.getDCM_CHANNEL_NAME();
                        PayLevelName = model.getDCM_PAYMENT_LEVEL();
                %>
                <TR class=TableTextNote>
                    ...
                    <td width="40%" nowrap align=middle><%=ChannelName%></td>
                    <td width="40%" nowrap align=middle><%=PayLevelName%></td>
