...
<html>
   ...
   System.out.println("in EXPORT Month List JSP : HASHMAP_KEY_USER_ID "+str1+" and USER_ID "+str2+" session HASHMAP_KEY_USER_ID "+str3);
   ...
   System.out.println("user id in EXPORT month list jsp is Finally : "+userID);
...
<form action="com.mobinil.sds.web.controller.UploadingFileServlet" name="GenerateSheet" id="GenerateSheet" method="post">
    ...
    <script>
        function back ()
        {
            ...
            document.GenerateSheet.action=document.GenerateSheet.action+'<%=InterfaceKey.HASHMAP_KEY_ACTION%>'+'='+'<%=AdministrationInterfaceKey.ACTION_SHOW_LIST_OF_THE_MONTH%>';
