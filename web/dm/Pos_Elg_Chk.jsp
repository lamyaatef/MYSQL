...
<%
    ...
    String formAction = appName + "/servlet/com.mobinil.sds.web.controller.WebControllerServlet?"
            ...
            + DMInterfaceKey.ACTION_POS_ELG_CHK_IMPORT_PROCESS
...
<script>
    ...
    function submitForm()
    {
        ...
        var year1= document.myform.<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_ELG_YEAR);%>.value;
        var month1 = document.myform.<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_ELG_MONTH);%>.value;
        ...
        document.myform.action = document.myform.action+'&'+'<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_ELG_YEAR);%>='+year1;
        document.myform.action = document.myform.action+'&'+'<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_ELG_MONTH);%>='+month1;
...
<HTML>
    <HEAD>
        ...
        <TITLE>POS Eligibility Check</TITLE>
    <center>
        <h2>POS Eligibility Check</h2>
    </center>
</HEAD>
    ...
    <form name="myform" action="<%out.print(formAction);%>"method="post" enctype="multipart/form-data">
        ...
        <table style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="70%" border=1 align="center">
            ...
            <tr>
                <td width="15%">Year:</td>
                <td>
                    <select name="<%=DMInterfaceKey.CONTROL_SELECT_POS_ELG_YEAR%>" id="<%=DMInterfaceKey.CONTROL_SELECT_POS_ELG_YEAR%>">
                        <option></option>
            ...
            <tr>
                <td>Month:</td>
                <td>
                    <select  name="<%=DMInterfaceKey.CONTROL_SELECT_POS_ELG_MONTH%>" id="<%=DMInterfaceKey.CONTROL_SELECT_POS_ELG_MONTH%>">
                        <option></option>
                        <%
