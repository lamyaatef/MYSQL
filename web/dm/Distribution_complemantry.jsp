...
String appName = request.getContextPath();
  ...
  String strUserID = (String)dataHashMap.get(InterfaceKey.HASHMAP_KEY_USER_ID);
    ...
    String formAction = appName +"/servlet/com.mobinil.sds.web.controller.WebControllerServlet?"
                    ...
                    +DMInterfaceKey.ACTION_COMPLEMANTRY_DISTRIBUTION_IMPORT_PROCESS+
...
function submitForm()
{
  ...
  var year1= document.myform.<%out.print(DMInterfaceKey.CONTROL_SELECT_COMP_DIST_YEAR);%>.value;
  var month1 = document.myform.<%out.print(DMInterfaceKey.CONTROL_SELECT_COMP_DIST_MONTH);%>.value;
  ...
  document.myform.action = document.myform.action+'&'+'<%out.print(DMInterfaceKey.CONTROL_SELECT_COMP_DIST_YEAR);%>='+year1;
  document.myform.action = document.myform.action+'&'+'<%out.print(DMInterfaceKey.CONTROL_SELECT_COMP_DIST_MONTH);%>='+month1;
...
<HTML>
   <HEAD>
      ...
      <TITLE>Distribution And Complemantry Import</TITLE>
      <center>
      <h2>Distribution And Complemantry Import</h2>
      </center>
   </HEAD>
...
<form name="myform" action="<%out.print(formAction);%>"method="post" enctype="multipart/form-data">
            ...
            <table style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="70%" border=1 align="center">
                ...
                <td width="15%">Year:</td>
                <td>
                <select name="<%=DMInterfaceKey.CONTROL_SELECT_COMP_DIST_YEAR %>" id="<%=DMInterfaceKey.CONTROL_SELECT_COMP_DIST_YEAR %>">
                <option></option>
                ...
                <td>Month:</td>
                <td>
                <select  name="<%=DMInterfaceKey.CONTROL_SELECT_COMP_DIST_MONTH%>" id="<%=DMInterfaceKey.CONTROL_SELECT_COMP_DIST_MONTH%>">
                <option></option>
                <%
