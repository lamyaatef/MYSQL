...
String appName = request.getContextPath();
  ...
  String strUserID = (String)dataHashMap.get(InterfaceKey.HASHMAP_KEY_USER_ID);
    ...
    String formAction = appName +"/servlet/com.mobinil.sds.web.controller.WebControllerServlet?"
                    ...
                    +DMInterfaceKey.ACTION_POS_PAY_HISTORY_IMPORT_PROCESS+
...
function submitForm()
{
  ...
  var year1= document.myform.<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_HIS_YEAR);%>.value;
  var month1 = document.myform.<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_HIS_MONTH);%>.value;
  ...
  document.myform.action = document.myform.action+'&'+'<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_HIS_YEAR);%>='+year1;
  document.myform.action = document.myform.action+'&'+'<%out.print(DMInterfaceKey.CONTROL_SELECT_POS_HIS_MONTH);%>='+month1;
...
<HTML>
   <HEAD>
      ...
      <TITLE>POS Payment History </TITLE>
      <center>
      <h2>POS Payment History </h2>
      </center>
   </HEAD>
...
<form name="myform" action="<%out.print(formAction);%>"method="post" enctype="multipart/form-data">
            ...
            <table style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="70%" border=1 align="center">
                ...
                <td width="15%">Year:</td>
                <td>
                <select name="<%=DMInterfaceKey.CONTROL_SELECT_POS_HIS_YEAR %>" id="<%=DMInterfaceKey.CONTROL_SELECT_POS_HIS_YEAR %>">
                <option></option>
                ...
                <td>Month:</td>
                <td>
                <select  name="<%=DMInterfaceKey.CONTROL_SELECT_POS_HIS_MONTH%>" id="<%=DMInterfaceKey.CONTROL_SELECT_POS_HIS_MONTH%>">
                <option></option>
                <%
