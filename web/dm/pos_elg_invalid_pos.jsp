...
%>  
  ...
  <%
	...
	System.out.println("ddddddddddddddddddd: "+file_path);
	 ...
	 file_path  = file_path + "/invalid_pos"+fileId+".txt";
    ...
    --%>
     ...
     for (int i=0;i<vecdata.size();i++){
    	 PosElgInvalidPosCode model = (PosElgInvalidPosCode) vecdata.get(i);
  ...
  --%>
   ...
   %>
     ...
     printToStream("</h3>",out);
         ...
         printToStream("<h3>",out);
         printToStream("No Invalid POS code:",out);
         printToStream("</h3>",out);	 
