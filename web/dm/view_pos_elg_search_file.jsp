...
out.println("<input type=\"hidden\" name=month value=\""+"\">");
  ...
  String nextAction="";
  nextAction=DMInterfaceKey.ACTION_DELETE_ELG_CHK_SEARCH_FILE;
  
  String nextAction1="";
  nextAction1=DMInterfaceKey.ACTION_VIEW_ELG_CHK_SEARCH_FILE;
  
  
  String nextAction2="";
  nextAction2=DMInterfaceKey.ACTION_VIEW_ELG_CHK_SEARCH_FILE_DATA;
  
  String   nextAction3="";
nextAction3=DMInterfaceKey.ACTION_VIEW_ELG_CHK_SEARCH_FILE_INVALID_POS;
    ...
    <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
      <TR class=TableHeader>
        ...
        <td width="20%" nowrap align=middle>Year</td>
         ...
         <td width="30%" nowrap align=middle>Export Invalid POS</td>
...
"loadField("+model.getSEARCH_FILE_ID()+");AUTHform.submit();\">"); 
      ...
      out.println("<INPUT class=button type=button    value= \"Export Invalid POS\"  name =\"Export Invalid POS\"onclick=\"AUTHform."+InterfaceKey.HASHMAP_KEY_ACTION+".value='"+nextAction3+"';"+
  "loadField("+model.getSEARCH_FILE_ID()+");AUTHform.submit();\">"); 
           }
        %>
        </TD>   
