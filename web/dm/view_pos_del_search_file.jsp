...
out.println("<input type=\"hidden\" name=year value=\""+"\">");
  ...
  String nextAction="";
  nextAction=DMInterfaceKey.ACTION_DELETE_DEL_CHK_SEARCH_FILE;
  ...
  String nextAction2="";
  nextAction2=DMInterfaceKey.ACTION_VIEW_DEL_CHK_SEARCH_FILE_DATA;
  
  String   nextAction3="";
nextAction3=DMInterfaceKey.ACTION_VIEW_DEL_CHK_SEARCH_FILE_INVALID_POS;
    ...
    <TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=2 cellPadding=1 width="100%" border=1>
      <TR class=TableHeader>
        ...
        <td width="20%" nowrap align=middle>Year</td>
         ...
         <td width="30%" nowrap align=middle>Export Invalid DCM</td>
