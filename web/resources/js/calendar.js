...
//$$$ removed this block because it might lead to swapping month and day
/*
...
"parent.opener.cal_opentwice=false;" +
"} " +
"</SCRIPT>" +
"</HEAD>" +
"<BODY onLoad='calControl.today.focus();calControl.today.blur();' BGCOLOR='" +topBackground+ "' LANGUAGE=javascript onunload='return window_onunload()'>" +
"<CENTER>" + 
...
calWin = window.open('javascript:opener.calDocFrameset','calWin','dependent=yes,'+windowSize+',top=' + (event.screenY - (windowHeight/2)) + ',left=' + (event.screenX - (windowWidth/2)) + ',titlebar=yes');
