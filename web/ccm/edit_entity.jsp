 ...
 {	
	  String nextAction=CCMInterfaceKey.ACTION_UPDATE_ENTITY;
		...
		if ((flag.compareTo("2")==0))
		{
			...
			nextAction=CCMInterfaceKey.ACTION_UPDATE_ENTITY;	
		}
...
<TABLE style="WIDTH: 746px; BORDER-COLLAPSE: collapse; HEIGHT: 91px"
	...
	<TR class=TableTextNote>
        ...
        for (int i=0;i<vecmandatoryData.size();i++)
           ...
           EntityMandatoryDataModel model = (EntityMandatoryDataModel) vecmandatoryData.get(i);
	 	   address1=model.getEntityAdress(); 
...
out.println("<input type=\"hidden\" name=\""+CCMInterfaceKey.INPUT_SEARCH_TEXT_ENTITY_CODE+"\""+
        " value=\""+code1+"\">"); 
out.println("<input type=\"hidden\" name=\""+CCMInterfaceKey.INPUT_SEARCH_TEXT_ENTITY_NAME+"\""+
        " value=\""+Entityname+"\">"); 
%>
