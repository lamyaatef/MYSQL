    ...
    public TeamleaderImporter (String userId,String fileDate,Long fileID , String filePath , int minColumns)
    {
        ...
        int count = 0;
            ...
            //    System.out.println("NOMAD line = input.readLine() "+input.readLine());
                        ...
                        if (count == 1) {
                         ...
                         if (count > 1) {//!=0
                            ...
                            if(lineFields!=null)
                           {
                            ...
                            if (v1 == null) 
                                v1 = "";
                            TeamleaderFileDAO.insertTeamleaderData(con, stat,userId,isemptyField,lineFields,fileID,sellerIndx,statusIndx,count,mobileIndx,emailIndx/*,fileDate,updateOn*/);
                    ...
                    this.numberOfRowsInserted = --count;//TeamleaderFileDAO.getTeamleaderDataRecords(con, stat, fileID);
