...
public class SalesrepImporter {
    ...
    public SalesrepImporter (String userId,String fileDate,Long fileID , String filePath , int minColumns)
    {
    ...
    public SalesrepImporter(OPCPackage pkg) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OPCPackage p = OPCPackage.open(xlsxFile.getPath(), PackageAccess.READ);
        SalesrepImporter xlsx2csv = new SalesrepImporter(p);
        xlsx2csv.process();
        p.close();
    }
}