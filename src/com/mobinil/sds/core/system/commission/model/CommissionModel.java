...
public void setCommissionCreationDate(String commissionCreationDate) {
  ...
  String commissionSubtractID =null;
...
public void setCommissionItemDCMIDs(Vector newCommissionItemDCMIDs)
{
  ...
  public CommissionModel(Connection con,ResultSet rs)throws Exception
  {
      ...
      commissionSubtractID = rs.getString("subtractid");
      try {
      dpId = rs.getString("DP_ID");    
      } catch (Exception e) {          
      }
      try {
      dpName = rs.getString("DP_NAME");    
      } catch (Exception e) {          
      }
      try {
      dataViewName = rs.getString("DATA_VIEW_NAME");    
      setCommissionDataViewSQL(rs.getString("COMMISSION_DATA_VIEW_SQL"));
      } catch (Exception e) {          
      }
  ...
  public String getCommissionSubtractId()
  {
	return  commissionSubtractID; 
  }
  
  public void setcommissionSubtractId(String commissionSubtractId)
  {
	  this.commissionSubtractID = commissionSubtractId;
  }
