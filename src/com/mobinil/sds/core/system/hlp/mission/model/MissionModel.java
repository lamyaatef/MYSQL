...
public class MissionModel implements Serializable
{
  ...
  int numberOfUsers;
  int numberOfTargetUsers;
  int numberOfSurveysCompleted;
  int numberOfSurveysIncompleted;
  ...
  public MissionModel(ResultSet res)
  {
    try
    {
  ...
  public int getNumberOfTargetUsers()
  {
  return numberOfTargetUsers;
  }
  public void setNumberOfTargetUsers(int newNumberOfTargetUsers)
  {
  numberOfTargetUsers= newNumberOfTargetUsers;
  }
  ...
  public void setNumberOfSurveysCompleted(int newNumberOfSurveysCompleted)
  {
  numberOfSurveysCompleted= newNumberOfSurveysCompleted;
  }
  
  public int getNumberOfSurveysIncompleted()
  {
  return numberOfSurveysIncompleted;
  }
  public void setNumberOfSurveysIncompleted(int newNumberOfSurveysIncompleted)
  {
  numberOfSurveysIncompleted= newNumberOfSurveysIncompleted;
  }
}