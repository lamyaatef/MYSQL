                    ...
                    while ((line = input.readLine()) != null) {
                        ...
                        if (count == 1) {
                           //System.out.println("inside count 1 ") ;
                            ...
                            {
                                //System.out.println("fieldUpdatedOn[i] : "+fieldUpdatedOn[i]);
                               ...
                               // System.out.println("selleer user name ="+ SELLER_USERNAME);
                                if (fieldUpdatedOn[i].compareToIgnoreCase(UPDATED_ON)==0)
                                {
                                    ...
                                    updateOn = i;
                                    //updateOn ++;
                                   // System.out.println("index of updated on : "+updateOn);
                                ...
                                if (fieldUpdatedOn[i].compareToIgnoreCase(SELLER_USERNAME)==0)
                                {
                                    sellerIndx = i;
                                    //updateOn ++;
                                 //   System.out.println("index of updated on : "+sellerIndx);
                                ...
                                if (fieldUpdatedOn[i].compareToIgnoreCase(STATUS_NAME)==0)
                                {
                                    statusIndx = i;
                                    //updateOn ++;
                                   // System.out.println("index of updated on : "+statusIndx);
