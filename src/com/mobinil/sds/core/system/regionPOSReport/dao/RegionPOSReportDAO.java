...
"distinct vw_supervisor_assignment.region_name as supervisor_region_name,\n" +
"\n" +
...
" \n" +
" \n" +
" /*dcm_user.manager_dcm_user_id as teamleader_id,\n" +
" teamleader_detail.user_full_name  as teamleader_name,\n" +
" teamleader.manager_dcm_user_id as supervisor_id,\n" +
" supervisor_detail.user_full_name  as supervisor_name*/\n" +
" \n" +
" --vw_rep_district_supervisor.sup_id,\n" +
"--vw_rep_district_supervisor.supervisor_name\n" +
" \n" +
"  \n" +
"FROM dcm_pos_detail,\n" +
"  gen_dcm,\n" +
...
"and LOWER(vw_supervisor_assignment.region_name) like LOWER('%cairo%')\n" +
"and vw_supervisor_assignment.region_level_type_id = 1\n" +
"\n" +
"\n" +
...
"\n" +
"/*and dcm_user.manager_dcm_user_id = teamleader.dcm_user_id\n" +
"and teamleader_detail.user_detail_id = teamleader.user_detail_id\n" +
"\n" +
"and teamleader.manager_dcm_user_id = supervisor.dcm_user_id\n" +
"and supervisor.user_detail_id = supervisor_detail.user_detail_id*/\n" +
"\n" +
"--and vw_rep_district_supervisor.rep_id = vw_sales_rep_assignment.salesrep_id\n" +
"--and vw_rep_district_supervisor.salesrep_district_id = vw_sales_rep_assignment.SALESREP_DISTRICT_ID\n" +
"\n" +
...
"AND dcm_region.parent_REGION_ID                  = vw_sales_rep_assignment.SALESREP_DISTRICT_ID(+)  \n" +
"AND vw_sales_rep_assignment.SALESREP_DISTRICT_ID = vw_supervisor_assignment.DISTRICT_REGION_ID(+)\n" +
"and LOWER(vw_supervisor_assignment.region_name) like LOWER('%Upper%')\n" +
"and vw_supervisor_assignment.region_level_type_id = 1\n" +
