 ...
 *  2010 Copyright (C) Software Applications Networking and Development SAND (S.A.E) All
     rights reserved
 *  Email: contactus@sandcti.com
 *  No part of this work may be copied, reproduced, or translated in any
 *  form or medium without the prior written consent of SAND.
 *  The restriction covers all publication media, including but not limited to,
 *  CD-ROM. All other rights reserved.
 *  If permission is granted, the wording "provided with permission of SAND" and
 *  the date must be noted and SAND must be provided with a copy of the final product.
 */
