...
public class CommissionIIHandler 
{
		...
		try
		{
			...
			case COMMISSION_SAVE_NEW_COMMISSION_PARAM:
			{
				...
				Vector paramList = reportEngine.constructReportParamList(paramHashMap);
                                /*hagry to shady the above vector we need to loop on it and save it in a new table 
                                each object is of type parameterFieldDTO
                                * has both m_strLabelText m_nValueType they should be saved by teh commission id as well 
                                * 
                                */
